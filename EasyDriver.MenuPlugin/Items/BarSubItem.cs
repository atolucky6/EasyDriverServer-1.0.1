...
{
    [Serializable]
    internal class BarSubItem : BarComponentBase
    {
        #region Members
        ...
        public BarSubItem(string displayName = null, ImageSource imageSource = null) : base(displayName, imageSource)
        {
            Type = BarItemType.SubItem;
        }
        ...
        {
            var cloneItem = MemberwiseClone() as BarSubItem;
