...
{
    [Serializable]
    internal class BarSplitButtonItem : BarComponentBase
    {
        #region Members
        ...
        public BarSplitButtonItem(string displayName = null, ImageSource imageSource = null) : base(displayName, imageSource)
        {
