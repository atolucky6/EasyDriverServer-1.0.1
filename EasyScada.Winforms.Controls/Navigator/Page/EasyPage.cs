...
namespace EasyScada.Winforms.Controls.Navigator
{
	...
	/// </summary>
	[ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyPage), "NavigatorBitmaps.EasyPage.bmp")]
    [DefaultEvent("Click")]
	[DefaultProperty("Text")]
    [Designer(typeof(EasyPageDesigner))]
    [DesignerCategory("code")]
	[DesignTimeVisible(false)]
    public class EasyPage : VisualPanel
    {
        ...
        public event EasyPageFlagsEventHandler FlagsChanged;
		...
		#region Identity
        /// <summary>
		/// Initialize a new instance of the EasyPage class.
		/// </summary>
        public EasyPage()
            : this("Page", null)
        {
        ...
        public EasyPage(string text, string uniqueName)
        ...
        /// <param name="uniqueName">Initial unique name.</param>
        public EasyPage(string text, Image imageSmall, string uniqueName)
		{
            // Default properties
            Text = text;
            ...
            _flags.Flags = (int)(EasyPageFlags.All);
            _flags.ClearFlags((int)EasyPageFlags.PageInOverflowBarForOutlookMode);
        ...
        [DefaultValue(null)]
        public virtual EasyContextMenu EasyContextMenu
        {
            get { return _kcm; }
            ...
            set 
            {
                ...
                {
                    if (_kcm != null)
                        _kcm.Disposed += new EventHandler(OnEasyContextMenuDisposed);
        ...
        public virtual string GetTextMapping(MapEasyPageText mapping)
        {
            ...
            switch (mapping)
            {
                case MapEasyPageText.Text:
                case MapEasyPageText.TextTitle:
                case MapEasyPageText.TextTitleDescription:
                case MapEasyPageText.TextDescription:
                    ret = Text;
                    break;
                case MapEasyPageText.Title:
                case MapEasyPageText.TitleDescription:
                case MapEasyPageText.TitleText:
                    ret = TextTitle;
                    break;
                case MapEasyPageText.Description:
                case MapEasyPageText.DescriptionText:
                case MapEasyPageText.DescriptionTitle:
                case MapEasyPageText.DescriptionTitleText:
                    ret = TextDescription;
                    break;
                case MapEasyPageText.ToolTipTitle:
                    ret = ToolTipTitle;
                    break;
                case MapEasyPageText.ToolTipBody:
                    ret = ToolTipBody;
                    break;
            }
        ...
        public virtual Image GetImageMapping(MapEasyPageImage mapping)
        {
            Image ret = null;
            ...
            switch (mapping)
            {
                case MapEasyPageImage.Small:
                case MapEasyPageImage.SmallMedium:
                case MapEasyPageImage.SmallMediumLarge:
                    ret = ImageSmall;
                    break;
                case MapEasyPageImage.Medium:
                case MapEasyPageImage.MediumLarge:
                case MapEasyPageImage.MediumSmall:
                    ret = ImageMedium;
                    break;
                case MapEasyPageImage.Large:
                case MapEasyPageImage.LargeMedium:
                case MapEasyPageImage.LargeMediumSmall:
                    ret = ImageLarge;
                    break;
                case MapEasyPageImage.ToolTip:
                    ret = ToolTipImage;
                    break;
            }
        ...
        /// <summary>
        /// Gets the Easy control that is acting as the parent.
        /// </summary>
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public Control EasyParentContainer
        {
            [System.Diagnostics.DebuggerStepThrough]
        ...
        public virtual int Flags
        {
            ...
            set
            {
                if (_flags.Flags != value)
                {
                    ...
                    _flags.Flags = value;
                    OnFlagsChanged((EasyPageFlags)changed);
                }
            }
        }
        ...
        public virtual void SetFlags(EasyPageFlags flags)
        {
        ...
        /// </summary>
        /// <param name="flags">Flags to set.</param>
        public virtual void ClearFlags(EasyPageFlags flags)
        {
        ...
        public virtual bool AreFlagsSet(EasyPageFlags flags)
        {
                ...
                if (EasyContextMenu != null)
                {
                    ...
                    if (ClientRectangle.Contains(mousePt))
                    {
                        if (!DesignMode)
                        {
                            ...
                            EasyContextMenu.Show(this, PointToScreen(mousePt));
        ...
        protected virtual void OnFlagsChanged(EasyPageFlags changed)
        {
            if (FlagsChanged != null)
                FlagsChanged(this, new EasyPageFlagsEventArgs(changed));
        }
        ...
        private void OnEasyContextMenuDisposed(object sender, EventArgs e)
        {
            // When the current easy context menu is disposed, we should remove 
            // it to prevent it being used again, as that would just throw an exception 
            // because it has been disposed.
            EasyContextMenu = null;
        }
        #endregion
    }
}
