...
namespace EasyScada.Winforms.Controls.Navigator
{
    ...
    internal class ViewBuilderOutlookMini : ViewBuilderOutlookBase
    {
        ...
        protected override void ReorderCheckButtonsOverflow(EasyPage page,
        ...
        protected override bool AreMoreButtons()
        {
            ...
            foreach (EasyPage page in Navigator.Pages)
                if (page.LastVisibleSet && page.AreFlagsSet(EasyPageFlags.PageInOverflowBarForOutlookMode))
                    return true;
