...
namespace EasyScada.Winforms.Controls.Navigator
{
	...
	internal abstract class ViewBuilderBase
	{
        ...
        protected class PageToNavCheckItem : Dictionary<EasyPage, INavCheckItem> { };
        protected class PageToNavCheckButton : Dictionary<EasyPage, ViewDrawNavCheckButtonBase> { };
        #endregion
		...
		public virtual void Construct(EasyNavigator navigator, 
									  ViewManager manager,
        ...
        public virtual void PageVisibleStateChanged(EasyPage page)
        {
        }
        ...
        public virtual void PageEnabledStateChanged(EasyPage page)
        {
        }
        ...
        public virtual void PageAppearanceChanged(EasyPage page, string property)
        {
        }
        ...
        public virtual void PageFlagsChanged(EasyPage page, EasyPageFlags changed)
        {
        }
        ...
        public abstract EasyPage PageFromView(ViewBase element);
        ...
        public virtual void PerformNextAction(DirectionButtonAction action, EasyPage page)
        {
            // Process the requested action
            switch (action)
            {
        ...
        /// <param name="action">Requested action.</param>
        /// <param name="page">Selected page at time of action request.</param>
        public virtual void PerformPreviousAction(DirectionButtonAction action, EasyPage page)
        {
            // Process the requested action
            switch (action)
            {
        ...
        /// <returns>True if new page selected; otherwise false.</returns>
        public virtual bool SelectNextPage(EasyPage page, 
                                           bool wrap,
                                           bool ctrlTab)
        {
            // There must be at least one page and allowed to select a page
        ...
        /// <param name="ctrlTab">Associated with a Ctrl+Tab action.</param>
        /// <returns>True if new page selected; otherwise false.</returns>
        public virtual bool SelectPreviousPage(EasyPage page, 
                                               bool wrap,
                                               bool ctrlTab)
        {
            // There must be at least one page and allowed to select a page
