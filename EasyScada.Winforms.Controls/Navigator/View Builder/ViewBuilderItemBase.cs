...
namespace EasyScada.Winforms.Controls.Navigator
{
    ...
    internal abstract class ViewBuilderItemBase : ViewBuilderBase
    {
        ...
        public override EasyPage PageFromView(ViewBase element)
        {
            if (_pageLookup != null)
            {
                foreach (KeyValuePair<EasyPage, INavCheckItem> pair in _pageLookup)
        ...
        protected virtual INavCheckItem CreateCheckItem(EasyPage page,
        ...
        private void CreateNavCheckItems()
        {
            ...
            Navigator.Pages.Inserted += new TypedHandler<EasyPage>(OnItemPageInserted);
            Navigator.Pages.Removed += new TypedHandler<EasyPage>(OnItemPageRemoved);
        ...
        private void UpdateCheckItemStyle()
        {
            ...
            if (PageLookup != null)
                foreach (KeyValuePair<EasyPage, INavCheckItem> pair in PageLookup)
                {
        ...
        private void BringPageIntoView(EasyPage page)
        {
        ...
        private void OnItemPageRemoved(object sender, TypedCollectionEventArgs<EasyPage> e)
        {
            if (!Navigator.IsDisposed && (_events > 0))
            {
        ...
        private void OnItemPageInserted(object sender, TypedCollectionEventArgs<EasyPage> e)
        {
            if (!Navigator.IsDisposed && (_events > 0))
            {
