...
namespace EasyScada.Winforms.Controls.Navigator
{
	...
	/// </summary>
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(EasyNavigator), "NavigatorBitmaps.EasyNavigator.bmp")]
	[DefaultEvent("SelectedIndexChanged")]
	[DefaultProperty("Pages")]
    [Designer(typeof(EasyNavigatorDesigner))]
    [DesignerCategory("code")]
    [Description("Allows navigation between pages.")]
    [Docking(DockingBehavior.Ask)]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyNavigator : VisualSimple,
                                    IDragTargetProvider
    {
        ...
        private EasyGroupPanel _childPanel; 
        private ViewBuilderBase _viewBuilder;
        private EasyPage _selectedPage;
        ...
        public event EventHandler<EasyPageCancelEventArgs> Selecting;
        ...
        public event EventHandler<EasyPageEventArgs> Selected;
        ...
        public event EventHandler<EasyPageCancelEventArgs> Deselecting;
        ...
        public event EventHandler<EasyPageEventArgs> Deselected;
        ...
        public event EventHandler<EasyContextMenuEventArgs> OutlookDropDown;
        ...
        public event EventHandler<EasyPageEventArgs> TabClicked;
        ...
        public event EventHandler<EasyPageEventArgs> TabDoubleClicked;
        ...
        public event EventHandler<EasyPageEventArgs> TabMouseHoverStart;
		...
		/// <summary>
		/// Initialize a new instance of the EasyNavigator class.
		/// </summary>
		public EasyNavigator()
		{
        ...
        [Editor("EasyScada.Winforms.Controls.NavigatorPageCollectionEditor, ComponentFactory.Easy.Navigator, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e", typeof(UITypeEditor))]
                ...
                if (_selectedPage != value)
				{
                    ...
                    if (Pages.Contains(value))
                    {
                        ...
                        if (_selectedPage != null)
                        {
                            ...
                            EasyPageCancelEventArgs e1 = new EasyPageCancelEventArgs(_selectedPage, Pages.IndexOf(_selectedPage));
                        ...
                        // Create event information
                        EasyPageCancelEventArgs e2 = new EasyPageCancelEventArgs(value, Pages.IndexOf(value));
                        ...
                        EasyPage oldSelected = _selectedPage;
                        ...
                        if (oldSelected != null)
                            OnDeselected(new EasyPageEventArgs(oldSelected, Pages.IndexOf(oldSelected)));

                        // For the new selection, generate event to show it is selected
                        OnSelected(new EasyPageEventArgs(_selectedPage, Pages.IndexOf(_selectedPage)));
            ...
            set
            {
                if (_allowTabSelect != value)
                {
                    ...
                    if (!_allowTabSelect && (SelectedPage != null))
                    {
                        ...
                        OnDeselected(new EasyPageEventArgs(SelectedPage, SelectedIndex));
        ...
        {
            return GenerateDragTargets(dragEndData, EasyPageFlags.All);
        }
        ...
        /// <returns>List of drag targets.</returns>
        public virtual DragTargetList GenerateDragTargets(PageDragEndData dragEndData, EasyPageFlags allowFlags)
        {
        ...
        /// <summary>
        /// Gets the EasyPage associated with the provided point.
        ...
        /// <returns>EasyPage or null.</returns>
        public EasyPage PageFromPoint(Point pt)
        {
            if (ViewManager.Root != null)
            {
                ...
                while (view != null)
                {
                    ...
                    if ((view.Component != null) && (view.Component is EasyPage))
                        return (EasyPage)view.Component;
        ...
        /// <param name="wrap">Wrap around end of collection to the start.</param>
        /// <returns>True if a new page was selected; otherwise false.</returns>
        public bool SelectNextPage(EasyPage page, bool wrap)
        {
            // Perform view specific page selection
        ...
        /// <param name="wrap">Wrap around end of collection to the start.</param>
        /// <returns>True if a new page was selected; otherwise false.</returns>
        public bool SelectPreviousPage(EasyPage page, bool wrap)
        {
            // Perform view specific page selection
        ...
        /// <returns>Returns the action that was performed.</returns>
        public CloseButtonAction PerformCloseAction(EasyPage page)
        {
        ...
        public EasyGroupPanel ChildPanel
        {
        ...
        public void DebugOutput()
        {
            ...
            foreach (EasyPage page in Pages)
		...
		/// </summary>
		/// <returns>A new instance of EasyNavigatorControlCollection assigned to the control.</returns>
		protected override ControlCollection CreateControlsInstance()
		{
            //  User should never adds controls directly to collection, only via the pages collection
            return new EasyReadOnlyControls(this);
		}
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (SelectedPage != null)
            {
                if (SelectedPage.EasyContextMenu != null)
                    if (SelectedPage.EasyContextMenu.ProcessShortcut(keyData))
                        return true;
		...
		/// </summary>
		/// <param name="e">A EasyPageCancelEventArgs containing event details.</param>
		protected virtual void OnDeselecting(EasyPageCancelEventArgs e)
		{
			if (Deselecting != null)
				Deselecting(this, e);
		}
		...
		/// </summary>
		/// <param name="e">A EasyPageCancelEventArgs containing event details.</param>
		protected virtual void OnSelecting(EasyPageCancelEventArgs e)
		{
			if (Selecting != null)
				Selecting(this, e);
		}
		...
		/// </summary>
		/// <param name="e">A EasyPageEventArgs containing event details.</param>
		protected virtual void OnDeselected(EasyPageEventArgs e)
		{
			if (Deselected != null)
				Deselected(this, e);
		}
		...
		/// </summary>
		/// <param name="e">A EasyPageEventArgs containing event details.</param>
		protected virtual void OnSelected(EasyPageEventArgs e)
		{
			if (Selected != null)
				Selected(this, e);
		}
        ...
        /// <returns>Returns the action that was performed.</returns>
        protected virtual CloseButtonAction OnCloseAction(EasyPage page)
        {
        ...
        /// </summary>
        /// <param name="e">An EasyPageEventArgs containing the event args.</param>
        internal protected virtual void OnTabClicked(EasyPageEventArgs e)
        {
            if (TabClicked != null)
                TabClicked(this, e);
        }
        ...
        /// </summary>
        /// <param name="e">An EasyPageEventArgs containing the event args.</param>
        internal protected virtual void OnTabDoubleClicked(EasyPageEventArgs e)
        {
        ...
        internal protected virtual void OnOutlookDropDown(EasyContextMenu kcm)
        {
            if (OutlookDropDown != null)
                OutlookDropDown(this, new EasyContextMenuEventArgs(SelectedPage,
                                                                      SelectedIndex,
                                                                      kcm));
        }
        ...
        /// </summary>
        /// <param name="e">An EasyPageEventArgs containing event details.</param>
        protected virtual void OnTabMouseHoverStart(EasyPageEventArgs e)
        {
        ...
        internal EasyPage FirstActionPage()
        {
        ...
        internal EasyPage LastActionPage()
        {
        ...
        internal EasyPage PreviousActionPage(EasyPage page)
        {
        ...
        internal EasyPage NextActionPage(EasyPage page)
        {
            Debug.Assert(page != null);
        ...
        internal void ShowPopupPage(EasyPage page,
                                    ViewBase relative,
        ...
        internal void BorrowChildPanel()
        {
            if (!IsChildPanelBorrowed)
            {
                ...
                ((EasyReadOnlyControls)Controls).RemoveInternal(ChildPanel);
        ...
        internal void ReturnChildPanel()
        {
            if (IsChildPanelBorrowed)
            {
                ...
                ((EasyReadOnlyControls)Controls).AddInternal(ChildPanel);
                _borrowedChildPanel = false;
            }
        }

        internal void InternalDragStart(DragStartEventCancelArgs e, EasyPage page)
        {
            if (DesignMode)
                e.Cancel = true;
            else
            {
                ...
                if (page != null)
                    _dragPages = new EasyPage[] { page };
                else
                {
                    // Providing 'null' means we want all the pages
                    List<EasyPage> list = new List<EasyPage>();
                    foreach (EasyPage p in Pages)
                        list.Add(p);
                ...
                foreach(EasyPage p in _dragPages)
                    if (p.AreFlagsSet(EasyPageFlags.AllowPageDrag))
                    {
                        allowPageDrag = true;
                        break;
                    }
                ...
                if (!de.Cancel)
                {
                    ...
                    List<EasyPage> list = new List<EasyPage>();
                    foreach (EasyPage p in de.Pages)
                        list.Add(p);
                    _dragPages = list.ToArray();
        ...
        internal void InternalDragEnd(PointEventArgs e)
        {
            if (_pageDragging && (DragPageNotify != null))
            {
                if (DragPageNotify.PageDragEnd(this, e))
                {
                    ...
                    foreach (EasyPage page in _dragPages)
                        if (Pages.Contains(page))
                            Pages.Remove(page);
                }
            }
        ...
        private void CreatePageCollection()
        {
            ...
            _pages.Inserted += new TypedHandler<EasyPage>(OnPageInserted);
            _pages.Removing += new TypedHandler<EasyPage>(OnPageRemoving);
            _pages.Removed += new TypedHandler<EasyPage>(OnPageRemoved);
        ...
        private void CreateStorageObjects()
        {
            ...
            _button.ContextButton.EasyContextMenu.Opening += new CancelEventHandler(OnOpeningContextMenu);
        }
        ...
        private void CreateChildControl()
        {
            ...
            _childPanel = new EasyGroupPanel(this, 
            ...
            ((EasyReadOnlyControls)Controls).AddInternal(_childPanel);
        }
        ...
        private void OnPageInserted(object sender, TypedCollectionEventArgs<EasyPage> e)
		{
            // Ignore call as view builder is already destructed
            if (!IsDisposed && (_viewBuilder != null))
            {
                ...
                e.Item.FlagsChanged += new EasyPageFlagsEventHandler(OnPageFlagsChanged);
        ...
        private void OnPageRemoving(object sender, TypedCollectionEventArgs<EasyPage> e)
		{
            // Ignore call as view builder is already destructed
            if (!IsDisposed && (_viewBuilder != null))
            {
        ...
        private void OnPageRemoved(object sender, TypedCollectionEventArgs<EasyPage> e)
		{
            // Ignore call as view builder is already destructed
            if (!IsDisposed && (_viewBuilder != null))
            {
		...
		private void OnPageClearing(object sender, EventArgs e)
		{
            ...
            foreach (EasyPage page in Pages)
            {
                ...
                // Unhook from page events
                page.FlagsChanged -= new EasyPageFlagsEventHandler(OnPageFlagsChanged);
        ...
        private void OnPageFlagsChanged(object sender, EasyPageFlagsEventArgs e)
        {
            // Ignore call as view builder is already destructed
            if (!IsDisposed && (_viewBuilder != null))
            {
        ...
        {
            EasyPage newSelection = null;
            EasyPage firstEnabled = null;
            EasyPage firstDisabled = null;

            // Process all pages
            for (int i = 0; i < Pages.Count; i++)
            {
                // Get the page to examine
                EasyPage next = Pages[i];
                ...
                if (next.LastVisibleSet)
                {
                    ...
                    // Create event information
                    EasyPageCancelEventArgs args = new EasyPageCancelEventArgs(next, Pages.IndexOf(next));
            ...
            if (SelectedPage != null)
            {
                ...
                OnSelected(new EasyPageEventArgs(SelectedPage, SelectedIndex));
            }
        ...
        private void SelectNextAvailablePage(EasyPage begin)
        {
            // Generate event to show it is now deselected
            OnDeselected(new EasyPageEventArgs(begin, Pages.IndexOf(begin)));
        ...
        private void OnOpeningContextMenu(object sender, CancelEventArgs e)
        {
            ...
            if (!IsDisposed && (_viewBuilder != null))
            {
                ...
                else
                {
                    ...
                    EasyContextMenu contextMenu = (EasyContextMenu)sender;

                    // Kill any existing contents and add a items collection for the page entries
                    contextMenu.Items.Clear();
                    EasyContextMenuItems contextMenuItems = new EasyContextMenuItems();
                    ...
                    foreach (EasyPage page in Pages)
                    {
                        ...
                        if ((page == SelectedPage) || (page.LastVisibleSet && page.Enabled))
                        {
                            ...
                            {
                                EasyContextMenuSeparator vertBreak = new EasyContextMenuSeparator();
                                vertBreak.Horizontal = false;
                                contextMenuItems.Items.Add(vertBreak);
                            }

                            // Create a menu item for the page
                            EasyContextMenuItem pageMenuItem = new EasyContextMenuItem(page.GetTextMapping(Button.ContextMenuMapText),
        ...
        private void OnShowToolTip(object sender, ToolTipEventArgs e)
        {
            if (!IsDisposed && (_viewBuilder != null))
            {
                ...
                if (!DesignMode)
                {
                    ...
                    EasyPage toolTipPage = _viewBuilder.PageFromView(e.Target);

                    // If the tooltip is for a easy page header
                    if (toolTipPage != null)
                    {
        ...
        private void OnStartHover(object sender, ToolTipEventArgs e)
        {
            if (!IsDisposed && (_viewBuilder != null))
            {
                ...
                if (!DesignMode)
                {
                    ...
                    EasyPage hoverPage = _viewBuilder.PageFromView(e.Target);
                    if (hoverPage != null)
                    {
                        OnTabMouseHoverStart(new EasyPageEventArgs(hoverPage, Pages.IndexOf(hoverPage)));
        ...
        {
            // If a easy page is being removed
            if (e.Control is EasyPage)
            {
                // Cast to correct type
                EasyPage page = (EasyPage)e.Control;
                    ...
                    do
                    {
                        ...
                        else
                        {
                            ...
                            if ((next != this) || ((next == this) && _viewBuilder.CanFocus))
                            {
                                ...
                                // Cannot select a control if that control is on an unselected easy page
                                if (!NextOnUnselectedEasyPage(next))
                                {
        ...
        private bool NextOnUnselectedEasyPage(Control next)
        {
            do
            {
                // Is this control actually a EasyPage?
                if (next is EasyPage)
                {
                    // Cast to the correct type
                    EasyPage page = (EasyPage)next;

                    // If the page is inside a easy container that is a navigator instance
                    if ((page.EasyParentContainer != null) && (page.EasyParentContainer is EasyNavigator))
                    {
                        // Cast to correct type
                        EasyNavigator nav = (EasyNavigator)page.EasyParentContainer;
            ...
            // Did not find the control is on a EasyPage, so definitely not on an unselected EasyPage
            return false;
        }
        ...
        private void ResetCachedEasyContextMenu()
        {
            // First time around we need to create the context menu
            if (_kcm == null)
                _kcm = new EasyContextMenu();
        ...
        {
            // Cast to correct type
            EasyContextMenuItem menuItem = (EasyContextMenuItem)sender;

            // Get the page this menu item referencs
            EasyPage page = (EasyPage)menuItem.Tag;
