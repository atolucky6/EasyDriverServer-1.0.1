...
namespace EasyScada.Winforms.Controls.Navigator
{
    ...
    /// <summary>
    /// Collection for managing ButtonSpecAny instances for a EasyPage.
    /// </summary>
    public class PageButtonSpecCollection : ButtonSpecCollection<ButtonSpecAny>
    {
        ...
        public PageButtonSpecCollection(EasyPage owner)
            : base(owner)
        {
        }
        #endregion
    ...
    /// <summary>
    /// Collection for managing NavigatorButtonSpec instances for a EasyNavigator.
    /// </summary>
    ...
    { 
        ...
        /// </summary>
        /// <param name="owner">Reference to owning object.</param>
        public NavigatorButtonSpecCollection(EasyNavigator owner)
            : base(owner)
        {
        }
        #endregion
    ...
    { 
        ...
        /// </summary>
        /// <param name="owner">Reference to owning object.</param>
        public NavFixedButtonSpecCollection(EasyNavigator owner)
            : base(owner)
        {
        }
        #endregion
    ...
    #region Enum EasyPageFlags
    /// <summary>
    /// Specifies flags that can be applied to a EasyPage
    /// </summary>
    [Flags()]
    public enum EasyPageFlags : int
    {
    ...
    public enum NavigatorMode
    {
        ...
        /// <summary>Specifies a EasyHeaderGroup style of appearance.</summary>
        HeaderGroup,

        /// <summary>Specifies a EasyHeaderGroup style of appearance combined with a set of tabs.</summary>
        HeaderGroupTab,

        /// <summary>Specifies a EasyGroup style of appearance.</summary>
        Group,

        /// <summary>Specifies a EasyPanel style of appearance.</summary>
        Panel,
    }
    #endregion

    #region Enum MapEasyPageText
    /// <summary>
    /// Specifies the mapping from EasyPage text property.
    /// </summary>
    [TypeConverter(typeof(MapEasyPageTextConverter))]
    public enum MapEasyPageText
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies use of the EasyPage.Text property.
        /// </summary>
        Text,
        ...
        /// <summary>
        /// Specifies use of the EasyPage.TextTitle property.
        /// </summary>
        Title,
        ...
        /// <summary>
        /// Specifies use of the EasyPage.TextDescription property.
        /// </summary>
        Description,
        ...
        /// <summary>
        /// Specifies use of the EasyPage.ToolTipTitle property.
        /// </summary>
        ToolTipTitle,

        /// <summary>
        /// Specifies use of the EasyPage.ToolTipBody property.
        /// </summary>
        ToolTipBody,
    }
    #endregion

    #region Enum MapEasyPageImage
    /// <summary>
    /// Specifies the mapping from EasyPage image property.
    /// </summary>
    [TypeConverter(typeof(MapEasyPageImageConverter))]
    public enum MapEasyPageImage
    {
        /// <summary>
        /// Specifies no mapping take place.
        /// </summary>
        ...
        /// <summary>
        /// Specifies use of the EasyPage.ImageSmall property.
        /// </summary>
        Small,
        ...
        /// <summary>
        /// Specifies use of the EasyPage.ImageMedium property.
        /// </summary>
        Medium,
        ...
        /// <summary>
        /// Specifies use of the EasyPage.ImageLarge property.
        /// </summary>
        Large,
        ...
        /// <summary>
        /// Specifies use of the EasyPage.ToolTipImage property.
        /// </summary>
        ToolTip,
    }
    #endregion
    ...
    public interface IDragPageNotify
    {
        ...
        void PageDragStart(object sender, EasyNavigator navigator, PageDragCancelEventArgs e);
    ...
    #region Delegates
    /// <summary>
    /// Signature of method that provides a EasyPageFlags enumeration value.
    /// </summary>
    /// <param name="sender">Source of the call.</param>
    /// <param name="e">A EasyPageFlagsEventArgs containing event information.</param>
    public delegate void EasyPageFlagsEventHandler(object sender, EasyPageFlagsEventArgs e);
    #endregion
}
