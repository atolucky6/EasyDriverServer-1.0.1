...
namespace EasyScada.Winforms.Controls.Navigator
{
    ...
    /// </summary>
    public class EasyNavigatorDesigner : ParentControlDesigner
	{
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _navigator = (EasyNavigator)component;
            ...
            foreach (EasyPage page in _navigator.Pages)
            ...
            _navigator.Pages.Inserted += new TypedHandler<EasyPage>(OnPageInserted);
            _navigator.Pages.Removed += new TypedHandler<EasyPage>(OnPageRemoved);
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new EasyNavigatorActionList(this));
        ...
        {
            // Only a EasyPage can be added as a child
            if (control is EasyPage)
            {
        ...
        /// </summary>
        protected EasyNavigator Navigator
        {
        ...
        protected virtual void OnComponentRemoving(object sender, ComponentEventArgs e)
        {
            ...
            if (e.Component == _navigator)
            {
                ...
                {
                    EasyPage page = _navigator.Pages[i];
                    _changeService.OnComponentChanging(_navigator, null);
        ...
        private void OnAddPage(object sender, EventArgs e)
        {
            ...
            DesignerTransaction transaction = _designerHost.CreateTransaction("EasyNavigator AddPage");
            ...
            try
            {
                ...
                EasyPage page = (EasyPage)_designerHost.CreateComponent(typeof(EasyPage));
        ...
        {
            // Use a transaction to support undo/redo actions
            DesignerTransaction transaction = _designerHost.CreateTransaction("EasyNavigator RemovePage");
            ...
            try
            {
                ...
                EasyPage removePage = _navigator.SelectedPage;
