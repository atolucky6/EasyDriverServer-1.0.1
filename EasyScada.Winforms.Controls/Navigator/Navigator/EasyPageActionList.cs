...
{
    internal class EasyPageActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPageActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyPageActionList(EasyPageDesigner owner)
            : base(owner.Component)
        {
            // Remember designer and actual component instance being designed
            _page = (EasyPage)owner.Component;
        ...
        {
            get { return _page.AreFlagsSet(EasyPageFlags.PageInOverflowBarForOutlookMode); }

            set
            {
                _serviceComponentChange.OnComponentChanged(_page, null, _page.AreFlagsSet(EasyPageFlags.PageInOverflowBarForOutlookMode), value);
