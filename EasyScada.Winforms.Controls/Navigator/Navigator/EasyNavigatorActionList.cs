...
namespace EasyScada.Winforms.Controls.Navigator
{
    ...
    /// </summary>
    public class EasyNavigatorActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyNavigator _navigator;
        private EasyNavigatorDesigner _designer;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyNavigatorActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyNavigatorActionList(EasyNavigatorDesigner owner)
            : base(owner.Component)
        {
            // Remember designer and actual component instance being designed
            _designer = owner;
            _navigator = (EasyNavigator)owner.Component;
                                       ...
                                       bool includeHeaderBar)
        {
            ...
            if (includeHeaderBar)
            {
                ...
                actions.Add(new EasyDesignerActionItem(_headerBarVisible, "Header"));
            }
            ...
            if (includeHeaderPrimary)
            {
                ...
                actions.Add(new EasyDesignerActionItem(_headerPrimaryVisible, "Header"));
            }
            ...
            if (includeHeaderSecondary)
            {
                ...
                actions.Add(new EasyDesignerActionItem(_headerSecondaryVisible, "Header"));
            }
        }
