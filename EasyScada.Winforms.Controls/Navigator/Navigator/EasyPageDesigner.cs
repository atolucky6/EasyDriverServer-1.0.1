...
{
    internal class EasyPageDesigner : ScrollableControlDesigner,
                                         IEasyDesignerSelect
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _page = (EasyPage)component;

            // Hook into page events
            _page.FlagsChanged += new EasyPageFlagsEventHandler(OnPageFlagsChanged);
        ...
        {
            // Can only place a KrytonPage in the EasyNavigator
            if (parentDesigner != null)
                return (parentDesigner.Component is EasyNavigator);
            else
                return false;
        }
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new EasyPageActionList(this));
        ...
        {
            EasyPageFormEditFlags editFlags = new EasyPageFormEditFlags(_page);
        ...
        private EasyNavigator ParentNavigator
        {
            get
            {
                ...
                while(parent != null)
                {
                    if (parent is EasyNavigator)
                        return (EasyNavigator)parent;
