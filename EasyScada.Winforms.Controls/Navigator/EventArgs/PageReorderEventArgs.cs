...
namespace EasyScada.Winforms.Controls.Navigator
{
    ...
    public class PageReorderEventArgs : CancelEventArgs
	{
        ...
        private EasyPage _pageMoving;
        private EasyPage _pageTarget;
        ...
        public PageReorderEventArgs(EasyPage pageMoving, 
                                    EasyPage pageTarget, 
                                    bool movingBefore)
		{
