...
namespace EasyScada.Winforms.Controls.Navigator
{
    ...
    public abstract class DragTarget : IDisposable
    {
        ...
        private EasyPageFlags _allowFlags;
        ...
        /// </summary>
        public EasyPageFlags AllowFlags
        {
        ...
        protected EasyPage ProcessDragEndData(EasyNavigator target,
                                                 PageDragEndData data)
        {
            EasyPage ret = null;

            // Add each source page to the target
            foreach (EasyPage page in data.Pages)
            {
