...
namespace EasyScada.Winforms.Controls.Navigator
{
                               ...
                               IDisposable
    {
        ...
        public virtual void PageDragStart(object sender, EasyNavigator navigator, PageDragCancelEventArgs e)
        {
        ...
        private void ResolvePaletteRenderer()
        {
            ...
            switch (_paletteMode)
            {
                case PaletteMode.Custom:
                    ...
                    break;
                default:
                    _dragPalette = EasyManager.GetPaletteForMode(_paletteMode);
                    break;
            }
