...
{
    internal class EasyDomainUpDownActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyDomainUpDown _domainUpDown;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyDomainUpDownActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyDomainUpDownActionList(EasyDomainUpDownDesigner owner)
            : base(owner.Component)
        {
            // Remember the text box instance
            _domainUpDown = owner.Component as EasyDomainUpDown;
