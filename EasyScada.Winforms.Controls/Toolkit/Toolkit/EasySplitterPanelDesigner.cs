...
{
    internal class EasySplitterPanelDesigner : EasyPanelDesigner,
                                                  IEasyDesignerSelect
	{
		#region Instance Fields
		private EasySplitterPanel _panel;
		...
		public override void Initialize(IComponent component)
		{
            ...
            _panel = component as EasySplitterPanel;
			...
			// If inside a Easy split container then always lock the component from user size/location change
            if (_panel != null)
            {
                PropertyDescriptor descriptor = TypeDescriptor.GetProperties(component)["Locked"];
                if ((descriptor != null) && (_panel.Parent is EasySplitContainer))
        ...
        {
            // We should only ever exist inside a Easy split container
            return (parentDesigner is EasySplitContainerDesigner);
        }
		...
		public override SelectionRules SelectionRules
		{
			get
			{
				// If the panel is inside our Easy split container then prevent 
				// user changing the size or location of the split panel instance
				if (Control.Parent is EasySplitContainer)
		...
		#region Protected
		/// <summary>
		/// Releases the resources used by the EasySplitterPanelDesigner. 
		/// </summary>
		...
		protected override InheritanceAttribute InheritanceAttribute
		{
			get
			{
				// If we have a valid Easy splitter panel instance
				if ((_panel != null) && (_panel.Parent != null))
				{
