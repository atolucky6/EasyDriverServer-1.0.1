...
{
    internal class EasyBreadCrumbItemsEditor : CollectionEditor
    {
        #region Classes
        /// <summary>
        /// Form used for editing the EasyBreadCrumbItems.
        /// </summary>
        protected partial class EasyBreadCrumbItemsForm : CollectionEditor.CollectionForm
        {
            #region Types
            /// <summary>
            /// Simple class to reduce the length of declaractions!
            /// </summary>
            protected class DictItemBase : Dictionary<EasyBreadCrumbItem, EasyBreadCrumbItem> { };
            ...
            protected class CrumbProxy
            {
                ...
                private EasyBreadCrumbItem _item;
                #endregion
                ...
                public CrumbProxy(EasyBreadCrumbItem item)
                {
                    _item = item;
                }
                #endregion
            ...
            protected class MenuTreeNode : TreeNode
            {
                ...
                public MenuTreeNode(EasyBreadCrumbItem item)
                {
                    _item = item;
                ...
                /// </summary>
                public EasyBreadCrumbItem Item
                {
                    get { return _item; }
                }
            ...
            #region Instance Fields
            private EasyBreadCrumbItemsEditor _editor;
            ...
            #region Identity
            /// <summary>
            /// Initialize a new instance of the EasyBreadCrumbItemsForm class.
            /// </summary>
            public EasyBreadCrumbItemsForm(EasyBreadCrumbItemsEditor editor)
                : base(editor)
            {
                _editor = editor;
                ...
                this.Name = "EasyBreadCrumbCollectionForm";
            ...
            protected override void OnEditValueChanged()
            {
                if (EditValue != null)
                {
                    ...
                    foreach (EasyBreadCrumbItem item in Items)
            ...
            {
                EasyBreadCrumbItem item = (EasyBreadCrumbItem)CreateInstance(typeof(EasyBreadCrumbItem));
            ...
            private void UpdatePropertyGrid()
            {
                ...
                if (node == null)
                    ...
                    propertyGrid1.SelectedObject = new CrumbProxy((EasyBreadCrumbItem)((MenuTreeNode)node).PropertyObject);
            }
            ...
            private void AddItemsToDictionary(DictItemBase dictItems, EasyBreadCrumbItem baseItem)
            {
                // Add item to the dictionary
                dictItems.Add(baseItem, baseItem);

                // Add children of an items collection
                foreach (EasyBreadCrumbItem item in baseItem.Items)
                    AddItemsToDictionary(dictItems, item);
            }

            private void AddMenuTreeNode(EasyBreadCrumbItem item, MenuTreeNode parent)
            {
                ...
                // Add children of an items collection
                foreach (EasyBreadCrumbItem child in item.Items)
                                                ...
                                                ITypeDescriptorContext context)
            {
                ...
                foreach (EasyBreadCrumbItem item in after.Values)
                ...
                foreach (EasyBreadCrumbItem item in before.Values)
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyBreadCrumbItemsEditor class.
		/// </summary>
        public EasyBreadCrumbItemsEditor()
            : base(typeof(EasyBreadCrumbItem.BreadCrumbItems))
		{
        }
        #endregion
        ...
        {
            return new EasyBreadCrumbItemsForm(this);
        }
        #endregion
    }
}
