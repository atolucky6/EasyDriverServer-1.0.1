...
{
    internal class EasyTreeViewActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyTreeView _treeView;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyTreeViewActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyTreeViewActionList(EasyTreeViewDesigner owner)
            : base(owner.Component)
        {
            // Remember the tree view instance
            _treeView = owner.Component as EasyTreeView;
