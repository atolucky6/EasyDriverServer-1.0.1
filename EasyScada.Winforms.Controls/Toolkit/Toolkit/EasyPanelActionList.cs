...
{
    internal class EasyPanelActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyPanel _panel;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPanelActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyPanelActionList(EasyPanelDesigner owner)
            : base(owner.Component)
        {
            // Remember the panel instance
            _panel = owner.Component as EasyPanel;
