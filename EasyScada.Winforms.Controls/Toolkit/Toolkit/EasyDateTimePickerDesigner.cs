...
{
    internal class EasyDateTimePickerDesigner : ControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _dateTimePicker = component as EasyDateTimePicker;
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new EasyDateTimePickerActionList(this));
