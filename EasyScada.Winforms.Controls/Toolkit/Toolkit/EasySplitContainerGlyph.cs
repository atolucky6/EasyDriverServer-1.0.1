...
{
    internal class EasySplitContainerGlyph : Glyph
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasySplitContainerGlyph class.
        /// </summary>
        ...
        public EasySplitContainerGlyph(ISelectionService selectionService,
                                          BehaviorService behaviorService,
                                          Adorner adorner,
                                          IDesigner relatedDesigner)
            : base(new EasySplitContainerBehavior(relatedDesigner))
        {
