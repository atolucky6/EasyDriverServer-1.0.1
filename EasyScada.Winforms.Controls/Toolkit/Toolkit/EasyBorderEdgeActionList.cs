...
{
    internal class EasyBorderEdgeActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyBorderEdge _borderEdge;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyBorderEdgeActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyBorderEdgeActionList(EasyBorderEdgeDesigner owner) 
            : base(owner.Component)
        {
            _borderEdge = owner.Component as EasyBorderEdge;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_borderEdge != null)
            {
                ...
                actions.Add(new EasyDesignerActionItem(new DesignerVerb(_action, new EventHandler(OnOrientationClick)), "Layout"));
