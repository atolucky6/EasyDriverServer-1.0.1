...
{
    internal class ThemedTextBoxActionList : DesignerActionList
    {
        #region Instance Fields
        private ThemedTextBox _textBox;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyTextBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public ThemedTextBoxActionList(ThemedTextBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the text box instance
            _textBox = owner.Component as ThemedTextBox;
