...
{
    internal class EasyPanelDesigner : ScrollableControlDesigner
	{
		#region Identity
		/// <summary>
        /// Initialize a new instance of the EasyPanelDesigner class.
		/// </summary>
        public EasyPanelDesigner()
        {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new EasyPanelActionList(this));
