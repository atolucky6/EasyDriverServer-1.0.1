...
{
    internal partial class EasyCheckButtonCollectionForm : Form
    {
        ...
        private class ListEntry
        {
            ...
            public ListEntry(EasyCheckButton checkButton)
            {
            ...
            /// </summary>
            public EasyCheckButton CheckButton
            {
        ...
        #region Instance Fields
        private EasyCheckSet _checkSet;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyCheckButtonCollectionForm class.
        /// </summary>
        public EasyCheckButtonCollectionForm()
            : this(null)
        {
        }
        ...
        /// Initialize a new instance of the EasyCheckButtonCollectionForm class.
        /// </summary>
        public EasyCheckButtonCollectionForm(EasyCheckSet checkSet)
        {
        ...
        private void EasyCheckButtonCollectionForm_Load(object sender, EventArgs e)
        {
            ...
            if (container != null)
            {
                ...
                foreach (object obj in container.Components)
                {
                    ...
                    if (obj is EasyCheckButton)
                    {
                        // Cast to the correct type
                        EasyCheckButton checkButton = (EasyCheckButton)obj;
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            ...
            List<EasyCheckButton> copy = new List<EasyCheckButton>();
            foreach (EasyCheckButton checkButton in _checkSet.CheckButtons)
            ...
            foreach(EasyCheckButton checkButton in copy)
