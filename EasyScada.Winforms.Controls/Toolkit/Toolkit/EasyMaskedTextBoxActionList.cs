...
{
    internal class EasyMaskedTextBoxActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyMaskedTextBox _maskedTextBox;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyMaskedTextBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyMaskedTextBoxActionList(EasyMaskedTextBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the text box instance
            _maskedTextBox = owner.Component as EasyMaskedTextBox;
