...
{
    internal class EasyCheckedListBoxActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyCheckedListBox _checkedListBox;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyCheckedListBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyCheckedListBoxActionList(EasyCheckedListBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the list box instance
            _checkedListBox = owner.Component as EasyCheckedListBox;
