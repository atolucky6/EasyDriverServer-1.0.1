...
{
    internal class EasySplitContainerActionList : DesignerActionList
    {
        #region Instance Fields
        private EasySplitContainer _splitContainer;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasySplitContainerActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasySplitContainerActionList(EasySplitContainerDesigner owner) 
            : base(owner.Component)
        {
            _splitContainer = owner.Component as EasySplitContainer;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_splitContainer != null)
            {
                ...
                actions.Add(new EasyDesignerActionItem(new DesignerVerb(_action, new EventHandler(OnOrientationClick)), "Splitter"));
