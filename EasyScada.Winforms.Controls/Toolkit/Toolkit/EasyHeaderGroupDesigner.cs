...
{
    internal class EasyHeaderGroupDesigner : ParentControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _headerGroup = component as EasyHeaderGroup;
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new EasyHeaderGroupActionList(this));
