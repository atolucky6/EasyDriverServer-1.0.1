...
{
    internal class EasySeparatorActionList : DesignerActionList
    {
        #region Instance Fields
        private EasySeparator _separator;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasySeparatorActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasySeparatorActionList(EasySeparatorDesigner owner)
            : base(owner.Component)
        {
            // Remember the link label instance
            _separator = owner.Component as EasySeparator;
