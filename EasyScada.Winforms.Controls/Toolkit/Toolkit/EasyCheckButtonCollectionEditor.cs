...
{
    internal class EasyCheckButtonCollectionEditor : UITypeEditor
    {
        /// <summary>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            if ((context != null) && (context.Instance != null) && (provider != null))
            {
                ...
                if (editorService != null)
                {
                    ...
                    EasyCheckSet checkSet = (EasyCheckSet)context.Instance;

                    // Create the dialog used to edit the set of EasyCheckButtons
                    EasyCheckButtonCollectionForm dialog = new EasyCheckButtonCollectionForm(checkSet);
