...
{
    internal class EasyHeaderGroupActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyHeaderGroup _headerGroup;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyHeaderGroupActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyHeaderGroupActionList(EasyHeaderGroupDesigner owner)
            : base(owner.Component)
        {
            // Remember the panel instance
            _headerGroup = owner.Component as EasyHeaderGroup;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_headerGroup != null)
            {
                ...
                actions.Add(new EasyDesignerActionItem(_visible1, "Primary Header"));
                ...
                actions.Add(new EasyDesignerActionItem(_visible2, "Secondary Header"));
