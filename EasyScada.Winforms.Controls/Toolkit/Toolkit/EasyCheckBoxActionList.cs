...
{
    internal class EasyCheckBoxActionList : DesignerActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyCheckBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyCheckBoxActionList(EasyCheckBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the checkbox instance
            _checkBox = owner.Component as EasyCheckBox;
