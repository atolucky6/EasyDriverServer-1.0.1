...
{
    internal class EasyWrapLabelActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyWrapLabel _wrapLabel;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyWrapLabelActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyWrapLabelActionList(EasyWrapLabelDesigner owner)
            : base(owner.Component)
        {
            // Remember the label instance
            _wrapLabel = owner.Component as EasyWrapLabel;
