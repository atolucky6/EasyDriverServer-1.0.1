...
{
    internal class EasyListBoxActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyListBox _listBox;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyListBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyListBoxActionList(EasyListBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the list box instance
            _listBox = owner.Component as EasyListBox;
