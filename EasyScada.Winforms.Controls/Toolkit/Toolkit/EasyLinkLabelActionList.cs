...
{
    internal class EasyLinkLabelActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyLinkLabel _linkLabel;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyLinkLabelActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyLinkLabelActionList(EasyLinkLabelDesigner owner)
            : base(owner.Component)
        {
            // Remember the link label instance
            _linkLabel = owner.Component as EasyLinkLabel;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_linkLabel != null)
            {
                ...
                actions.Add(new EasyDesignerActionItem(new DesignerVerb(_action, new EventHandler(OnLinkVisitedClick)), "Appearance"));
