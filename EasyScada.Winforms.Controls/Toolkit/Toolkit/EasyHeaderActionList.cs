...
{
    internal class EasyHeaderActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyHeader _header;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyHeaderActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyHeaderActionList(EasyHeaderDesigner owner)
            : base(owner.Component)
        {
            // Remember the header instance
            _header = owner.Component as EasyHeader;
