...
{
    internal class EasyButtonActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyButton _button;
        ...
        public EasyButtonActionList(EasyButtonDesigner owner) 
            : base(owner.Component)
        {
            // Remember the button instance
            _button = owner.Component as EasyButton;
