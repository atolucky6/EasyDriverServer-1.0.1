...
{
	internal class EasySplitContainerDesigner : ParentControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _splitContainer = component as EasySplitContainer;

            // Create a new adorner and add our splitter glyph
            _adorner = new Adorner();
            _adorner.Glyphs.Add(new EasySplitContainerGlyph(_selectionService, _behaviorService, _adorner, this));
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new EasySplitContainerActionList(this));
