...
{
    internal class ThemedButtonActionList : DesignerActionList
    {
        #region Instance Fields
        private ThemedButton _button;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyButtonActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public ThemedButtonActionList(ThemedButtonDesigner owner) 
            : base(owner.Component)
        {
            // Remember the button instance
            _button = owner.Component as ThemedButton;
