...
{
    internal class EasyBreadCrumbActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyBreadCrumb _breadCrumb;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyBreadCrumbActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyBreadCrumbActionList(EasyBreadCrumbDesigner owner)
            : base(owner.Component)
        {
            // Remember the bread crumb control instance
            _breadCrumb = owner.Component as EasyBreadCrumb;
