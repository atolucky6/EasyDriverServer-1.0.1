...
{
    internal class EasyRadioButtonActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyRadioButton _radioButton;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyRadioButtonActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyRadioButtonActionList(EasyRadioButtonDesigner owner)
            : base(owner.Component)
        {
            // Remember the radio button instance
            _radioButton = owner.Component as EasyRadioButton;
