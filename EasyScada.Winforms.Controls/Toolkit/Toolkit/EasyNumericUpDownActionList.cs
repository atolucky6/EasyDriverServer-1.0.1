...
{
    internal class EasyNumericUpDownActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyNumericUpDown _numericUpDown;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyNumericUpDownActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyNumericUpDownActionList(EasyNumericUpDownDesigner owner)
            : base(owner.Component)
        {
            // Remember the text box instance
            _numericUpDown = owner.Component as EasyNumericUpDown;
