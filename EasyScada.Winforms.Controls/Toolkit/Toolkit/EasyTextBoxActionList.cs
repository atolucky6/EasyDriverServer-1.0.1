...
{
    internal class EasyTextBoxActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyTextBox _textBox;
        ...
        public EasyTextBoxActionList(EasyTextBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the text box instance
            _textBox = owner.Component as EasyTextBox;
