...
{
    internal class EasyMonthCalendarDesigner : ControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            _monthCalendar = component as EasyMonthCalendar;
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                ...
                actionLists.Add(new EasyMonthCalendarActionList(this));
