...
{
    internal class EasyTrackBarActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyTrackBar _trackBar;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyTrackBarActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyTrackBarActionList(EasyTrackBarDesigner owner) 
            : base(owner.Component)
        {
            _trackBar = owner.Component as EasyTrackBar;
