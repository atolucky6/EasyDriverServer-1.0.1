...
{
    internal class EasyLabelActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyLabel _label;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyLabelActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyLabelActionList(EasyLabelDesigner owner)
            : base(owner.Component)
        {
            // Remember the label instance
            _label = owner.Component as EasyLabel;
