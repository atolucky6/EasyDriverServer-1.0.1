...
{
    internal class EasyRichTextBoxActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyRichTextBox _richTextBox;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyRichTextBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyRichTextBoxActionList(EasyRichTextBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the text box instance
            _richTextBox = owner.Component as EasyRichTextBox;
