...
{
    internal class EasyDropButtonActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyDropButton _dropButton;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyDropButtonActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyDropButtonActionList(EasyDropButtonDesigner owner) 
            : base(owner.Component)
        {
            // Remember the button instance
            _dropButton = owner.Component as EasyDropButton;
