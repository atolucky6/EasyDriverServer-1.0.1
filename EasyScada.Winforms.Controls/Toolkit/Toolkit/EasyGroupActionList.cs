...
{
    internal class EasyGroupActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyGroup _group;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyGroupActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyGroupActionList(EasyGroupDesigner owner) 
            : base(owner.Component)
        {
            // Remember the group instance
            _group = owner.Component as EasyGroup;
