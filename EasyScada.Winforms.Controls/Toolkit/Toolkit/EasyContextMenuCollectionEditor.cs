...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
	public class EasyContextMenuCollectionEditor : CollectionEditor
    {
        #region Classes
        /// <summary>
        /// Form used for editing the EasyContextMenuCollection.
        /// </summary>
        protected partial class EasyContextMenuCollectionForm : CollectionEditor.CollectionForm
        {
            #region Types
            /// <summary>
            /// Simple class to reduce the length of declaractions!
            /// </summary>
            protected class DictItemBase : Dictionary<EasyContextMenuItemBase, EasyContextMenuItemBase> { };
            ...
            protected class MenuTreeNode : TreeNode
            {
                ...
                private EasyContextMenuItemBase _item;
                ...
                public MenuTreeNode(EasyContextMenuItemBase item)
                {
                ...
                /// </summary>
                public EasyContextMenuItemBase Item
                {
                    get { return _item; }
                }
                ...
                {
                    if (_item is EasyContextMenuCheckBox)
                        return 6;
                    else if (_item is EasyContextMenuCheckButton)
                        return 7;
                    else if (_item is EasyContextMenuColorColumns)
                        return 0;
                    else if (_item is EasyContextMenuHeading)
                        return 1;
                    else if (_item is EasyContextMenuItem)
                        return 2;
                    else if (_item is EasyContextMenuItems)
                        return 3;
                    else if (_item is EasyContextMenuLinkLabel)
                        return 8;
                    else if (_item is EasyContextMenuRadioButton)
                        return 5;
                    else if (_item is EasyContextMenuSeparator)
                        return 4;
                    else if (_item is EasyContextMenuImageSelect)
                        return 13;
                    else if (_item is EasyContextMenuMonthCalendar)
                        return 14;
            ...
            private EasyContextMenuCollectionEditor _editor;
            ...
            #region Identity
            /// <summary>
            /// Initialize a new instance of the EasyContextMenuCollectionForm class.
            /// </summary>
            public EasyContextMenuCollectionForm(EasyContextMenuCollectionEditor editor)
                : base(editor)
            {
                _editor = editor;
                ...
                this.imageList.Images.AddRange(new Image[]{
                    Properties.Resources.EasyContextMenuColorColumns,
                    Properties.Resources.EasyContextMenuHeading,
                    Properties.Resources.EasyContextMenuItem,
                    Properties.Resources.EasyContextMenuItems,
                    Properties.Resources.EasyContextMenuSeparator,
                    Properties.Resources.EasyRadioButton,
                    Properties.Resources.EasyCheckBox,
                    Properties.Resources.EasyCheckButton,
                    Properties.Resources.EasyLinkLabel,
                    Properties.Resources.delete2,
                    Properties.Resources.arrow_up_blue,
                    Properties.Resources.arrow_down_blue,
                    Properties.Resources.EasyContextMenuColorColumns,
                    Properties.Resources.EasyContextMenuImageSelect,
                    Properties.Resources.EasyMonthCalendar});
                ...
                this.Name = "EasyContextMenuEditorForm";
                this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
                this.Text = "EasyContextMenu Items Editor";
                this.Load += new System.EventHandler(this.EasyContextMenuEditorForm_Load);
            ...
            protected override void OnEditValueChanged()
            {
                if (EditValue != null)
                {
                    ...
                    foreach (EasyContextMenuItemBase item in Items)
            ...
            #region Implementation
            private void EasyContextMenuEditorForm_Load(object sender, EventArgs e)
            {
                // Set allowed categories into the property grid filter
                propertyGrid1.BrowsableAttributes = new AttributeCollection(new EasyPersistAttribute());
            }
            ...
            private void buttonMoveUp_Click(object sender, EventArgs e)
            {
                ...
                if (node != null)
                {
                    ...
                    else
                    {
                        ...
                        if (treeParentNode.Item is EasyContextMenuItems)
                        {
                            EasyContextMenuItems items = treeParentNode.Item as EasyContextMenuItems;
                            items.Items.Remove(treeNode.Item);
                            items.Items.Insert(index - 1, treeNode.Item);
                        }
                        else if (treeParentNode.Item is EasyContextMenuItem)
                        {
                            EasyContextMenuItem items = treeParentNode.Item as EasyContextMenuItem;
                            items.Items.Remove(treeNode.Item);
                            items.Items.Insert(index - 1, treeNode.Item);
                        }
            ...
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuItem)));
            }

            private void buttonAddItems_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuItems)));
            }

            private void buttonAddHeading_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuHeading)));
            }

            private void buttonAddMonthCalendar_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuMonthCalendar)));
            }

            private void buttonAddSeparator_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuSeparator)));
            }

            private void buttonAddCheckBox_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuCheckBox)));
            }

            private void buttonAddCheckButton_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuCheckButton)));
            }

            private void buttonAddRadioButton_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuRadioButton)));
            }

            private void buttonAddLinkLabel_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuLinkLabel)));
            }

            private void buttonAddColorColumns_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuColorColumns)));
            }

            private void buttonAddImageSelect_Click(object sender, EventArgs e)
            {
                AddNewItem((EasyContextMenuItemBase)CreateInstance(typeof(EasyContextMenuImageSelect)));
            }
            ...
            private void AddMenuTreeNode(EasyContextMenuItemBase item, MenuTreeNode parent)
            {
                ...
                if (item is EasyContextMenuItems)
                {
                    EasyContextMenuItems itemsCollection = (EasyContextMenuItems)item;
                    foreach (EasyContextMenuItemBase child in itemsCollection.Items)
                        AddMenuTreeNode(child, node);
                }
                else if (item is EasyContextMenuItem)
                {
                    EasyContextMenuItem itemsCollection = (EasyContextMenuItem)item;
                    foreach (EasyContextMenuItemBase child in itemsCollection.Items)
                        AddMenuTreeNode(child, node);
                }
            }

            private void AddNewItem(EasyContextMenuItemBase item)
            {
                ...
                else
                {
                    ...
                    if (selectedNode.Parent == null)
                    {
                        ...
                        if (item is EasyContextMenuItem)
                        {
                            MenuTreeNode treeSelectedNode = selectedNode as MenuTreeNode;
                            EasyContextMenuItems items = treeSelectedNode.Item as EasyContextMenuItems;
                    ...
                    else
                    {
                        ...
                        if (treeParentNode.Item is EasyContextMenuItems)
                        {
                            ...
                            {
                                MenuTreeNode treeSelectedNode = selectedNode as MenuTreeNode;
                                Debug.Assert(treeSelectedNode.Item is EasyContextMenuItem);
                                EasyContextMenuItem items = treeSelectedNode.Item as EasyContextMenuItem;
                                items.Items.Add(item);
                                selectedNode.Nodes.Add(newNode);
                            }
                        }
                        else if (treeParentNode.Item is EasyContextMenuItem)
                        {
                            ...
                            {
                                MenuTreeNode treeSelectedNode = selectedNode as MenuTreeNode;
                                Debug.Assert(treeSelectedNode.Item is EasyContextMenuItems);
                                EasyContextMenuItems items = treeSelectedNode.Item as EasyContextMenuItems;
                                items.Items.Add(item);
                                selectedNode.Nodes.Add(newNode);
                            }
            ...
            {
                EasyContextMenuItemBase item = null;
                EasyContextMenuItemBase parent = null;
                ...
                buttonAddItem.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuItem));
                buttonAddItems.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuItems));
                buttonAddSeparator.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuSeparator));
                buttonAddHeading.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuHeading));
                buttonAddMonthCalendar.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuMonthCalendar));
                buttonAddCheckBox.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuCheckBox));
                buttonAddCheckButton.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuCheckButton));
                buttonAddRadioButton.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuRadioButton));
                buttonAddLinkLabel.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuLinkLabel));
                buttonAddColorColumns.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuColorColumns));
                buttonAddImageSelect.Enabled = AllowAddItem(item, parent, typeof(EasyContextMenuImageSelect));
                buttonDelete.Enabled = (item != null);
            }

            private bool AllowAddItem(EasyContextMenuItemBase item,
                                      EasyContextMenuItemBase parent,
                                      Type addType)
            {
                // Special case the you can use add button on an Items collection so it adds an item inside it
                if ((item is EasyContextMenuItems) && addType.Equals(typeof(EasyContextMenuItem)))
                    return true;

                if (ItemInsideCollection(item, parent))
                {
                    EasyContextMenuCollection temp = new EasyContextMenuCollection();
                ...
                {
                    EasyContextMenuItemCollection temp1 = new EasyContextMenuItemCollection();
                    foreach (Type t in temp1.RestrictTypes)
                        if (t.Equals(addType))
                            return true;

                    if ((item != null) && (item is EasyContextMenuItem))
                    {
                        EasyContextMenuCollection temp2 = new EasyContextMenuCollection();
            ...
            private bool ValidInCollection(EasyContextMenuItemBase item)
            {
            ...
            private bool ValidInItemCollection(EasyContextMenuItemBase item)
            {
                Type addType = item.GetType();
                EasyContextMenuItemCollection temp = new EasyContextMenuItemCollection();
                foreach (Type t in temp.RestrictTypes)
                    if (t.Equals(addType))
                        return true;
            ...
            private bool ItemInsideCollection(EasyContextMenuItemBase item,
                                              EasyContextMenuItemBase parent)
            {
                ...
                else
                {
                    ...
                    return !(parent is EasyContextMenuItems);
                }
            }
            ...
            private void AddItemsToDictionary(DictItemBase dictItems, EasyContextMenuItemBase baseItem)
            {
                // Add item to the dictionary
                dictItems.Add(baseItem, baseItem);

                // Add children of an items collection
                if (baseItem is EasyContextMenuItems)
                {
                    EasyContextMenuItems items = (EasyContextMenuItems)baseItem;
                    foreach (EasyContextMenuItemBase childItem in items.Items)
                        AddItemsToDictionary(dictItems, childItem);
                }

                // Add children of an item
                if (baseItem is EasyContextMenuItem)
                {
                    EasyContextMenuItem item = (EasyContextMenuItem)baseItem;
                    foreach (EasyContextMenuItemBase childItem in item.Items)
                        AddItemsToDictionary(dictItems, childItem);
                }
            }
                                                ...
                                                ITypeDescriptorContext context)
            {
                ...
                foreach (EasyContextMenuItemBase item in after.Values)
                ...
                foreach (EasyContextMenuItemBase item in before.Values)
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuCollectionEditor class.
		/// </summary>
        public EasyContextMenuCollectionEditor()
            : base(typeof(EasyContextMenuCollection))
		{
        }
        #endregion
        ...
        {
            return new EasyContextMenuCollectionForm(this);
        }
		...
		{
            return new Type[] { typeof(EasyContextMenuItems),
                                typeof(EasyContextMenuSeparator),
                                typeof(EasyContextMenuHeading),
                                typeof(EasyContextMenuLinkLabel),
                                typeof(EasyContextMenuCheckBox),
                                typeof(EasyContextMenuCheckButton),
                                typeof(EasyContextMenuRadioButton),
                                typeof(EasyContextMenuColorColumns),
                                typeof(EasyContextMenuMonthCalendar),
                                typeof(EasyContextMenuImageSelect)};
		}
        #endregion
	}
}
