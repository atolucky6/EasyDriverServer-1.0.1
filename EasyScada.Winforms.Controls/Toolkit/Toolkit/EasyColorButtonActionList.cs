...
{
    internal class EasyColorButtonActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyColorButton _colorButton;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyColorButtonActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyColorButtonActionList(EasyColorButtonDesigner owner) 
            : base(owner.Component)
        {
            // Remember the button instance
            _colorButton = owner.Component as EasyColorButton;
