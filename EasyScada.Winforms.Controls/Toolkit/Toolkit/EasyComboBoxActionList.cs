...
{
    internal class EasyComboBoxActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyComboBox _comboBox;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyComboBoxActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyComboBoxActionList(EasyComboBoxDesigner owner)
            : base(owner.Component)
        {
            // Remember the combo box instance
            _comboBox = owner.Component as EasyComboBox;
