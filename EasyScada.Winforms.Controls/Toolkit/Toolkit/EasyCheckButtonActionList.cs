...
namespace EasyScada.Winforms.Controls
{
    internal class EasyCheckButtonActionList : ThemedButtonActionList
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyCheckButtonActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyCheckButtonActionList(EasyCheckButtonDesigner owner) 
            : base(owner)
        {
            // Remember the button instance
            _checkButton = owner.Component as EasyCheckButton;
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            if (_checkButton != null)
            {
                ...
                actions.Add(new EasyDesignerActionItem(new DesignerVerb(_action, new EventHandler(OnCheckedClick)), "Appearance"));
