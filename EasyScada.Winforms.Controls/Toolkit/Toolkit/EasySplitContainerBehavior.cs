...
{
    internal class EasySplitContainerBehavior : Behavior
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasySplitContainerBehavior class.
        /// </summary>
        /// <param name="relatedDesigner">Reference to the containing designer.</param>
        public EasySplitContainerBehavior(IDesigner relatedDesigner)
        {
            _splitContainer = relatedDesigner.Component as EasySplitContainer;
        }
        #endregion
        ...
        private static Point PointToSplitContainer(Glyph g, Point pt)
        {
            ...
            EasySplitContainerGlyph splitGlyph = (EasySplitContainerGlyph)g;
