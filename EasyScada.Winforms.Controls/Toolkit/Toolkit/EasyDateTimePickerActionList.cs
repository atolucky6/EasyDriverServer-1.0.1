...
{
    internal class EasyDateTimePickerActionList : DesignerActionList
    {
        #region Instance Fields
        private EasyDateTimePicker _dateTimePicker;
        private IComponentChangeService _service;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyDateTimePickerActionList class.
        /// </summary>
        /// <param name="owner">Designer that owns this action list instance.</param>
        public EasyDateTimePickerActionList(EasyDateTimePickerDesigner owner)
            : base(owner.Component)
        {
            // Remember the bread crumb control instance
            _dateTimePicker = owner.Component as EasyDateTimePicker;
