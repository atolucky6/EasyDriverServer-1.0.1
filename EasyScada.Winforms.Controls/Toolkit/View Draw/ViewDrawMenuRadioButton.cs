...
namespace EasyScada.Winforms.Controls
{
    internal class ViewDrawMenuRadioButton: ViewComposite
    {
        ...
        private EasyContextMenuRadioButton _radioButton;
        ...
        public ViewDrawMenuRadioButton(IContextMenuProvider provider,
                                       EasyContextMenuRadioButton radioButton)
		{
            _provider = provider;
        ...
        #region EasyContextMenuRadioButton
        /// <summary>
        /// Gets access to the actual radio button definiton.
        /// </summary>
        public EasyContextMenuRadioButton EasyContextMenuRadioButton
        {
