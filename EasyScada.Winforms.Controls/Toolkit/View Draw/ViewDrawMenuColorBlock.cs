...
namespace EasyScada.Winforms.Controls
{
    ...
    public class ViewDrawMenuColorBlock : ViewLeaf
    {
        ...
        private EasyContextMenuColorColumns _colorColumns;
        ...
        public ViewDrawMenuColorBlock(IContextMenuProvider provider,
                                      EasyContextMenuColorColumns colorColumns,
                                      Color color, 
                                      bool first, 
                                      bool last, 
                                      bool enabled)
        ...
        #region EasyContextMenuColorColumns
        /// <summary>
        /// Gets access to the actual color columns definiton.
        /// </summary>
        public EasyContextMenuColorColumns EasyContextMenuColorColumns
        {
