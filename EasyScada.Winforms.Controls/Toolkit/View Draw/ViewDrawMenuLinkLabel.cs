...
namespace EasyScada.Winforms.Controls
{
    internal class ViewDrawMenuLinkLabel : ViewComposite
    {
        ...
        private EasyContextMenuLinkLabel _linkLabel;
        ...
        public ViewDrawMenuLinkLabel(IContextMenuProvider provider,
                                     EasyContextMenuLinkLabel linkLabel)
		{
            _provider = provider;
            ...
            if (_linkLabel.EasyCommand != null)
            {
                _cachedCommand = _linkLabel.EasyCommand;
                _linkLabel.EasyCommand.PropertyChanged += new PropertyChangedEventHandler(OnCommandPropertyChanged);
            }
        }
        ...
        #region EasyContextMenuLinkLabel
        /// <summary>
        /// Gets access to the actual link label definiton.
        /// </summary>
        public EasyContextMenuLinkLabel EasyContextMenuLinkLabel
        {
