...
namespace EasyScada.Winforms.Controls
{
    internal class ViewDrawMenuCheckButton : ViewComposite
    {
        ...
        private EasyContextMenuCheckButton _checkButton;
        ...
        public ViewDrawMenuCheckButton(IContextMenuProvider provider,
                                       EasyContextMenuCheckButton checkButton)
		{
            _provider = provider;
            ...
            if (_checkButton.EasyCommand != null)
            {
                _cachedCommand = _checkButton.EasyCommand;
                _checkButton.EasyCommand.PropertyChanged += new PropertyChangedEventHandler(OnCommandPropertyChanged);
            }
        }
        ...
        #region EasyContextMenuCheckButton
        /// <summary>
        /// Gets access to the actual check button definiton.
        /// </summary>
        public EasyContextMenuCheckButton EasyContextMenuCheckButton
        {
