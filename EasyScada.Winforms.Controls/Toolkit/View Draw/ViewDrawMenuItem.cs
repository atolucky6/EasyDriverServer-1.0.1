...
namespace EasyScada.Winforms.Controls
{
	internal class ViewDrawMenuItem : ViewDrawCanvas
    {
        ...
        private EasyContextMenuItem _menuItem;
        ...
        private EasyCommand _cachedCommand;
                   ...
                   VisualOrientation.Top)
		{
            ...
            if (_menuItem.EasyCommand != null)
            {
                _cachedCommand = _menuItem.EasyCommand;
                _menuItem.EasyCommand.PropertyChanged += new PropertyChangedEventHandler(OnCommandPropertyChanged);
            }
        }
        ...
        #region EasyContextMenuItem
        /// <summary>
        /// Gets access to the context menu item we represent.
        /// </summary>
        public EasyContextMenuItem EasyContextMenuItem
        {
        ...
        public Image ResolveImage
        {
            get
            {
                if (_cachedCommand != null)
                {
                    if (_menuItem.LargeEasyCommandImage)
