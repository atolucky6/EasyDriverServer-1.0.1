...
namespace EasyScada.Winforms.Controls
{
    internal class ViewDrawMenuCheckBox : ViewComposite
    {
        ...
        private EasyContextMenuCheckBox _checkBox;
        ...
        public ViewDrawMenuCheckBox(IContextMenuProvider provider,
                                    EasyContextMenuCheckBox checkBox)
		{
            _provider = provider;
            _checkBox = checkBox;
            ...
            if (_checkBox.EasyCommand != null)
            {
                _cachedCommand = _checkBox.EasyCommand;
                _checkBox.EasyCommand.PropertyChanged += new PropertyChangedEventHandler(OnCommandPropertyChanged);
            }
        }
        ...
        #region EasyContextMenuCheckBox
        /// <summary>
        /// Gets access to the actual check box definiton.
        /// </summary>
        public EasyContextMenuCheckBox EasyContextMenuCheckBox
        {
