...
{
    internal class EasyOffice2007Renderer : EasyProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initialise a new instance of the EasyOffice2007Renderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public EasyOffice2007Renderer(EasyColorTable kct)
            : base(kct)
        {
        }
        #endregion
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            else if (e.ToolStrip is StatusStrip)
            {
                ...
                // Check if the status strip is inside a EasyForm and using the Office 2007 renderer, in 
                    ...
                    (ToolStripManager.Renderer is EasyOffice2007Renderer))
                {
                    ...
                    EasyForm easyForm = (EasyForm)owner;

                    // Finally check that the actual form is using custom chrome
                    if (easyForm.ApplyCustomChrome)
                    {
                        // Extend down into the bottom border
                        backRect.Height += easyForm.RealWindowBorders.Bottom;
                    }
                }
