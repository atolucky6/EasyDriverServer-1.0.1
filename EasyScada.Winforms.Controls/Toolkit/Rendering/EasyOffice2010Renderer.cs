...
{
    internal class EasyOffice2010Renderer : EasyProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initialise a new instance of the EasyOffice2010Renderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public EasyOffice2010Renderer(EasyColorTable kct)
            : base(kct)
        {
        }
        #endregion
