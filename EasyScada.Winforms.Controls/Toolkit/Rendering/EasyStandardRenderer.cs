...
{
    internal class EasyStandardRenderer : EasyProfessionalRenderer
    {
        #region Identity
        /// <summary>
        /// Initialise a new instance of the EasyStandardRenderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public EasyStandardRenderer(EasyColorTable kct)
            : base(kct)
        {
        }
        #endregion
