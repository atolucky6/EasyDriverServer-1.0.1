...
{
    internal class EasySparkleRenderer : EasyProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initialise a new instance of the EasySparkleRenderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public EasySparkleRenderer(EasyColorTable kct)
            : base(kct)
        {
        }
        #endregion
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            else if (e.ToolStrip is StatusStrip)
            {
                ...
                // Check if the status strip is inside a EasyForm and using the Sparkle renderer, in 
                    ...
                    (ToolStripManager.Renderer is EasySparkleRenderer))
                {
                    ...
                    if (easyForm.ApplyCustomChrome)
                    {
                        ...
                        Padding borders = easyForm.RealWindowBorders;
