...
namespace EasyScada.Winforms.Controls
{
    ...
    internal class ViewLayoutMenuItemSelect : ViewComposite
    {
        ...
        private EasyContextMenuImageSelect _itemSelect;
        ...
        public ViewLayoutMenuItemSelect(EasyContextMenuImageSelect itemSelect,
                                        IContextMenuProvider provider)
        {
            ...
            if (palette == null)
                palette = EasyManager.GetPaletteForMode(provider.ProviderPaletteMode);
