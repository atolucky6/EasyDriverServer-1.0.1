...
namespace EasyScada.Winforms.Controls
{
    ...
    [ToolboxBitmap(typeof(ButtonSpec), "ToolboxBitmaps.EasyButtonSpec.bmp")]
    [DefaultEvent("Click")]
                                       ...
                                       ICloneable
    {
        ...
        public virtual object Clone()
        {
            ...
            clone.EasyContextMenu = EasyContextMenu;
            clone.EasyCommand = EasyCommand;
            clone.Owner = Owner;
            clone.Tag = Tag;
            return clone;
        }
        ...
        /// <summary>
        /// Gets and sets the easy context menu for the button.
        /// </summary>
        [Localizable(true)]
        [Category("Behavior")]
        [Description("EasyContextMenu to show when the button is pressed.")]
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        [DefaultValue(null)]
        public EasyContextMenu EasyContextMenu
        {
            get { return _easyContextMenu; }
            set { _easyContextMenu = value; }
        }
        #endregion
        ...
        public virtual EasyCommand EasyCommand
        {
            ...
            set
            {
                if (_command != value)
                {
                    ...
                    _command = value;
                    OnButtonSpecPropertyChanged("EasyCommand");
