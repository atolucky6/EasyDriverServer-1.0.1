...
{
    /// <summary>
    /// Implementation for the fixed maximize button for easy form.
    /// </summary>
    public class ButtonSpecFormWindowMax : ButtonSpecFormFixed
    {
        ...
        public ButtonSpecFormWindowMax(EasyForm form)
            ...
            if (GetViewEnabled())
            {
                ...
                if (!EasyForm.InertForm)
                {
                    ...
                    if (GetView().ClientRectangle.Contains(mea.Location))
                    {
                        ...
                        if (EasyForm.WindowState == FormWindowState.Maximized)
                            EasyForm.SendSysCommand(PI.SC_RESTORE);
                        else
                            EasyForm.SendSysCommand(PI.SC_MAXIMIZE);
