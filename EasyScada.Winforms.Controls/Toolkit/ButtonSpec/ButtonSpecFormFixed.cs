...
namespace EasyScada.Winforms.Controls
{
    ...
    public abstract class ButtonSpecFormFixed : ButtonSpec
    {
        ...
        /// </summary>
        /// <param name="form">Reference to owning easy form.</param>
        /// <param name="fixedStyle">Fixed style to use.</param>
        public ButtonSpecFormFixed(EasyForm form,
        ...
        #region EasyForm
        /// <summary>
        /// Gets access to the owning easy form.
        /// </summary>
        protected EasyForm EasyForm
        {
            get { return _form; }
        }
        #endregion
