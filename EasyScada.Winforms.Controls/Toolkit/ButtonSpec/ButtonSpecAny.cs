...
namespace EasyScada.Winforms.Controls
{
    ...
    public class ButtonSpecAny : ButtonSpec
    {
        ...
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        [DefaultValue(null)]
        public override EasyCommand EasyCommand
        {
        ...
        protected override void OnButtonSpecPropertyChanged(string propertyName)
        {
            ...
            if (propertyName == "EasyCommand")
            {
                if (EasyCommand != null)
                {
                    if (Checked != ButtonCheckState.NotCheckButton)
                        Checked = (EasyCommand.Checked ? ButtonCheckState.Checked : ButtonCheckState.Unchecked);

                    Enabled = (EasyCommand.Enabled ? ButtonEnabled.True : ButtonEnabled.False);
                }
            }
            else if (propertyName == "Checked")
            {
                if (EasyCommand != null)
                    EasyCommand.Checked = (Checked == ButtonCheckState.Checked);
            }
        }
