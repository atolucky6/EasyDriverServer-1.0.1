...
{
    /// <summary>
    /// Implementation for the fixed close button for easy form.
    /// </summary>
    public class ButtonSpecFormWindowClose : ButtonSpecFormFixed
    {
        ...
        public ButtonSpecFormWindowClose(EasyForm form)
            ...
            if (GetViewEnabled())
            {
                ...
                if (!EasyForm.InertForm)
                {
                    ...
                    if (GetView().ClientRectangle.Contains(mea.Location))
                    {
                        ...
                        pi.SetValue(EasyForm, CloseReason.UserClosing, null);
                        ...
                        EasyForm.SendSysCommand(PI.SC_CLOSE, lParam);
