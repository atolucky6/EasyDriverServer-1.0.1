                                  ...
                                  IContentValues
    {
        ...
        private void OnClick(object sender, MouseEventArgs e)
        {
            ...
            if (!CommonHelper.DesignMode(_manager.Control))
            {
                ...
                // Does the button spec define a easy context menu?
                if ((_buttonSpec.EasyContextMenu != null) && (ViewButton != null))
                {
                    ...
                    _buttonSpec.EasyContextMenu.Closed += new ToolStripDropDownClosedEventHandler(OnEasyContextMenuClosed);
                    if (!_buttonSpec.EasyContextMenu.Show(_buttonSpec, pt))
                    {
        ...
        private void OnEasyContextMenuClosed(object sender, ToolStripDropDownClosedEventArgs e)
        {
