...
namespace EasyScada.Winforms.Controls
{
                                           ...
                                           IContextMenuTarget
    {
        ...
        private EasyContextMenuMonthCalendar _monthCalendar;
        ...
        public MonthCalendarController(EasyContextMenuMonthCalendar monthCalendar,
        ...
        public virtual bool MouseDown(Control c, Point pt, MouseButtons button)
        {
            ...
            if (button == MouseButtons.Left)
            {
                ...
                if ((c != null) && (c is EasyMonthCalendar) && !c.ContainsFocus)
                    c.Focus();
