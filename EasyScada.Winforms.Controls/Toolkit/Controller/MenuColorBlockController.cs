...
namespace EasyScada.Winforms.Controls
{
                                              ...
                                              IContextMenuTarget
	{
        ...
        private void PressColorBlock()
        {
            ...
            if (_menuColorBlock.EasyContextMenuColorColumns.AutoClose)
            {
        ...
        {
            _highlight = true;
            _menuColorBlock.EasyContextMenuColorColumns.OnTrackingColor(new ColorEventArgs(_menuColorBlock.Color));
            UpdateTarget();
        }
        ...
        {
            _highlight = false;
            _menuColorBlock.EasyContextMenuColorColumns.OnTrackingColor(new ColorEventArgs(Color.Empty));
            UpdateTarget();
        }
