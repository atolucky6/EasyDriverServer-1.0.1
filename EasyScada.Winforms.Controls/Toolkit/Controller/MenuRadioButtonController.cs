...
namespace EasyScada.Winforms.Controls
{
                                               ...
                                               IContextMenuTarget
	{
        ...
        private void PressMenuRadioButton(bool keyboard)
        {
            ...
            if (_menuRadioButton.EasyContextMenuRadioButton.AutoClose)
            {
            ...
            if (_menuRadioButton.EasyContextMenuRadioButton.AutoCheck)
            {
                // We only alter state if it is currently not checked
                if (!_menuRadioButton.EasyContextMenuRadioButton.Checked)
                    _menuRadioButton.EasyContextMenuRadioButton.Checked = true;
            }
        ...
        private void UpdateTarget()
        {
            ...
            _menuRadioButton.EasyContextMenuRadioButton.OverrideNormal.Apply = applyFocus;
            _menuRadioButton.EasyContextMenuRadioButton.OverrideDisabled.Apply = applyFocus;
