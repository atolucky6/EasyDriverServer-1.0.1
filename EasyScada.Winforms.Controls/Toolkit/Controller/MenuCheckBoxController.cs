...
namespace EasyScada.Winforms.Controls
{
                                            ...
                                            IContextMenuTarget
	{
        ...
        private void PressMenuCheckBox(bool keyboard)
        {
            ...
            if (_menuCheckBox.EasyContextMenuCheckBox.AutoClose)
            {
            ...
            if (_menuCheckBox.EasyContextMenuCheckBox.AutoCheck)
            {
                // Grab current state from command or ourself
                CheckState state = (_menuCheckBox.EasyContextMenuCheckBox.EasyCommand == null ? 
                                    _menuCheckBox.EasyContextMenuCheckBox.CheckState : 
                                    _menuCheckBox.EasyContextMenuCheckBox.EasyCommand.CheckState);
                ...
                switch (state)
                {
                    ...
                    case CheckState.Checked:
                        state = (_menuCheckBox.EasyContextMenuCheckBox.ThreeState ? CheckState.Indeterminate : CheckState.Unchecked);
                        break;
                ...
                if (_menuCheckBox.EasyContextMenuCheckBox.EasyCommand != null)
                    _menuCheckBox.EasyContextMenuCheckBox.EasyCommand.CheckState = state;
                else
                    _menuCheckBox.EasyContextMenuCheckBox.CheckState = state;    
        ...
        private void UpdateTarget()
        {
            ...
            _menuCheckBox.EasyContextMenuCheckBox.OverrideNormal.Apply = applyFocus;
            _menuCheckBox.EasyContextMenuCheckBox.OverrideDisabled.Apply = applyFocus;
