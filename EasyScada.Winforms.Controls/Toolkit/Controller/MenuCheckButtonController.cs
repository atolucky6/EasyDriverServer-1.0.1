...
namespace EasyScada.Winforms.Controls
{
                                               ...
                                               IContextMenuTarget
	{
        ...
        private void PressMenuCheckButton(bool keyboard)
        {
            ...
            if (_menuCheckButton.EasyContextMenuCheckButton.AutoClose)
            {
            ...
            if (_menuCheckButton.EasyContextMenuCheckButton.AutoCheck)
            {
                // Get the current checked state
                bool checkState = (_menuCheckButton.EasyContextMenuCheckButton.EasyCommand == null ?
                                   _menuCheckButton.EasyContextMenuCheckButton.Checked :
                                   _menuCheckButton.EasyContextMenuCheckButton.EasyCommand.Checked);

                // Invert state
                checkState = !checkState;

                // Set the state back again
                if (_menuCheckButton.EasyContextMenuCheckButton.EasyCommand == null)
                    _menuCheckButton.EasyContextMenuCheckButton.Checked = checkState;
                else
                    _menuCheckButton.EasyContextMenuCheckButton.EasyCommand.Checked = checkState;
            }
        ...
        private void UpdateTarget()
        {
            ...
            _menuCheckButton.EasyContextMenuCheckButton.OverrideDisabled.Apply = applyFocus;
            _menuCheckButton.EasyContextMenuCheckButton.OverrideNormal.Apply = applyFocus;
            _menuCheckButton.EasyContextMenuCheckButton.OverrideTracking.Apply = applyFocus;
            _menuCheckButton.EasyContextMenuCheckButton.OverridePressed.Apply = applyFocus;
            _menuCheckButton.EasyContextMenuCheckButton.OverrideCheckedNormal.Apply = applyFocus;
            _menuCheckButton.EasyContextMenuCheckButton.OverrideCheckedTracking.Apply = applyFocus;
            _menuCheckButton.EasyContextMenuCheckButton.OverrideCheckedPressed.Apply = applyFocus;
