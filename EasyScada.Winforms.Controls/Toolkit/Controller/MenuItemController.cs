...
namespace EasyScada.Winforms.Controls
{
                                        ...
                                        IContextMenuTarget
	{
        ...
        private void PressMenuItem()
        {
            ...
            if (_menuItem.EasyContextMenuItem.AutoClose)
            {
            ...
            _menuItem.EasyContextMenuItem.PerformClick();
        ...
        private void HighlightState()
        {
            if (_menuItem.ItemEnabled)
            {
                ...
                _menuItem.SplitSeparator.SetPalettes(_menuItem.EasyContextMenuItem.StateHighlight.ItemSplit.Back,
                                                     _menuItem.EasyContextMenuItem.StateHighlight.ItemSplit.Border);
                _menuItem.SetPalettes(_menuItem.EasyContextMenuItem.StateHighlight.ItemHighlight.Back,
                                      _menuItem.EasyContextMenuItem.StateHighlight.ItemHighlight.Border);
            }
            else
            {
                _menuItem.ElementState = PaletteState.Disabled;
                _menuItem.SplitSeparator.ElementState = PaletteState.Disabled;
                _menuItem.SplitSeparator.SetPalettes(_menuItem.EasyContextMenuItem.StateDisabled.ItemSplit.Back,
                                                     _menuItem.EasyContextMenuItem.StateDisabled.ItemSplit.Border);
                _menuItem.SetPalettes(_menuItem.EasyContextMenuItem.StateDisabled.ItemHighlight.Back,
                                      _menuItem.EasyContextMenuItem.StateDisabled.ItemHighlight.Border);
            }
        ...
        private void NormalState()
        {
            ...
            _menuItem.SplitSeparator.SetPalettes(_menuItem.EasyContextMenuItem.StateNormal.ItemSplit.Back,
                                                 _menuItem.EasyContextMenuItem.StateNormal.ItemSplit.Border);
            _menuItem.SetPalettes(_menuItem.EasyContextMenuItem.StateNormal.ItemHighlight.Back,
                                  _menuItem.EasyContextMenuItem.StateNormal.ItemHighlight.Border);
