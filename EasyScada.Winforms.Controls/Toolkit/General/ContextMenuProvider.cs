...
namespace EasyScada.Winforms.Controls
{
    ...
    public class ContextMenuProvider : IContextMenuProvider
    {
        ...
        private EasyContextMenuPositionH _showHorz;
        private EasyContextMenuPositionV _showVert;
        ...
        public ContextMenuProvider(EasyContextMenu contextMenu,
                                   ViewContextMenuManager viewManager,
                                   ViewLayoutStack viewColumns,
                                   IPalette palette,
                                   ...
                                   bool enabled)
        {
            _showHorz = EasyContextMenuPositionH.Left;
            _showVert = EasyContextMenuPositionV.Below;
        ...
        public bool ProviderShowSubMenuFixed(EasyContextMenuItem menuItem)
        {
        ...
        public Rectangle ProviderShowSubMenuFixedRect(EasyContextMenuItem menuItem)
        {
            if (HasParentProvider)
        ...
        /// </summary>
        public EasyContextMenuPositionH ProviderShowHorz 
        {
        ...
        /// </summary>
        public EasyContextMenuPositionV ProviderShowVert 
        { 
