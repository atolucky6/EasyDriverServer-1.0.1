...
namespace EasyScada.Winforms.Controls
{
    ...
    public interface IContextMenuProvider
    {
        ...
        bool ProviderShowSubMenuFixed(EasyContextMenuItem menuItem);
        ...
        Rectangle ProviderShowSubMenuFixedRect(EasyContextMenuItem menuItem);
        ...
        /// </summary>
        EasyContextMenuPositionH ProviderShowHorz { get; set; }

        /// <summary>
        /// Gets and sets the vertical setting used to position the menu.
        /// </summary>
        EasyContextMenuPositionV ProviderShowVert { get; set; }
    ...
    #region IEasyMonthCalendar
    /// <summary>
    /// Provides month calendar information.
    /// </summary>
    public interface IEasyMonthCalendar
    {
        /// <summary>
    ...
    #region IEasyDebug
    /// <summary>
	/// Exposes access to the debugging helpers for easy controls.
	/// </summary>
    public interface IEasyDebug
    {
        /// <summary>
        /// Reset the internal counters.
        /// </summary>
        void EasyResetCounters();

        /// <summary>
        /// Gets the number of layout cycles performed since last reset.
        /// </summary>
        int EasyLayoutCounter { get; }

        /// <summary>
        /// Gets the number of paint cycles performed since last reset.
        /// </summary>
        int EasyPaintCounter { get; }
    }
    #endregion

    #region IEasyDesignerSelect
    /// <summary>
	/// Exposes design time selection of parent control.
	/// </summary>
    public interface IEasyDesignerSelect
    {
        /// <summary>
    ...
    #region IEasyDesignObject
    /// <summary>
    /// Exposes interface for visual form to cooperate with a view for composition.
    /// </summary>
    public interface IEasyDesignObject
    {
        /// <summary>
    ...
    #region Enum EasyLinkBehavior
    /// <summary>
    /// Specifies the logic for underlining the link label short text.
    /// </summary>
    [TypeConverter(typeof(EasyLinkBehaviorConverter))]
    public enum EasyLinkBehavior
    {
        /// <summary>
    ...
    #region Enum EasyContextMenuPositionV
    /// <summary>
    /// Specifies the relative vertical position for showing a EasyContextMenu.
    /// </summary>
    public enum EasyContextMenuPositionV
    {
        /// <summary>
    ...
    #region Enum EasyContextMenuPositionH
    /// <summary>
    /// Specifies the relative horizontal position for showing a EasyContextMenu.
    /// </summary>
    public enum EasyContextMenuPositionH
    {
        /// <summary>
    ...
    /// <summary>
    /// Specifies selection mode of the EasyCheckedListBox.
    /// </summary>
