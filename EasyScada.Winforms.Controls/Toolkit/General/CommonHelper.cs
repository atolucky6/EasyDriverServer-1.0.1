...
namespace EasyScada.Winforms.Controls
{
    ...
    public static class CommonHelper
    {
        ...
        /// <summary>
        /// Decide if the EasyContextMenu should be displayed.
        /// </summary>
        /// <param name="kcm">Reference to context menu strip.</param>
        /// <returns>True to display; otherwise false.</returns>
        public static bool ValidEasyContextMenu(EasyContextMenu kcm)
        {
            // Must be a valid reference to examine
        ...
        public static void AddControlToParent(Control parent, Control c)
        {
            ...
            if (parent.Controls is EasyControlCollection)
            {
                // Then must use the internal method for adding a new instance
                EasyControlCollection cc = (EasyControlCollection)parent.Controls;
                cc.AddInternal(c);
            }
            else
            {
        ...
        public static void RemoveControlFromParent(Control c)
        {
            ...
            {
                // If the control collection is one of our internal collections...
                if (c.Parent.Controls is EasyControlCollection)
                {
                    // Then must use the internal method for adding a new instance
                    EasyControlCollection cc = (EasyControlCollection)c.Parent.Controls;
                    cc.RemoveInternal(c);
                }
                else
                {
