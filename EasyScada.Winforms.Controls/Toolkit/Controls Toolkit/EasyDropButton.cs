...
{
	/// <summary>
    /// Combines drop down button functionality with the styling features of the Easy Toolkit.
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("Click")]
	[DefaultProperty("Text")]
    [Designer(typeof(EasyDropButtonDesigner))]
    [ToolboxBitmap(typeof(EasyDropButton), "ToolkitBitmaps.EasyDropButton.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyDropButton : VisualSimpleBase, IButtonControl, IContentValues
	{
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyDropButton class.
		/// </summary>
        public EasyDropButton()
        {
        ...
        private bool ShowDropDown()
        {
            ...
            if (EasyContextMenu != null)
            {
                if (PaletteMode != PaletteMode.Custom)
                    EasyContextMenu.PaletteMode = PaletteMode;
                else
                    EasyContextMenu.Palette = Palette;
            }
