...
namespace EasyScada.Winforms.Controls
{
    ...
    [ToolboxBitmap(typeof(EasyTaskDialog), "ToolkitBitmaps.EasyTaskDialog.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyTaskDialog : Component, INotifyPropertyChanged
    {
        ...
        #region Identity
        /// <summary>
        ///  Initialize a new instance of the EasyTaskDialog class.
        /// </summary>
        public EasyTaskDialog()
        {
            _radioButtons = new EasyTaskDialogCommandCollection();
            _commandButtons = new EasyTaskDialogCommandCollection();
        ...
        [Browsable(true)]
        public EasyTaskDialogCommandCollection RadioButtons
        {
        ...
        [RefreshProperties(RefreshProperties.All)]
        [Browsable(true)]
        public EasyTaskDialogCommandCollection CommandButtons
        {
        ...
        public EasyTaskDialogCommand DefaultRadioButton
        {
                                        ...
                                        TaskDialogButtons commonButtons)
        {
            ...
            using (EasyTaskDialog taskDialog = new EasyTaskDialog())
            {
