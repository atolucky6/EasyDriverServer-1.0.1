...
namespace EasyScada.Winforms.Controls
{
    ...
    [ToolboxBitmap(typeof(EasyTaskDialogCommand), "ToolkitBitmaps.EasyTaskDialogCommand.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyTaskDialogCommand : Component, IEasyCommand, INotifyPropertyChanged
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyCommand class.
        /// </summary>
        public EasyTaskDialogCommand()
        {
            _enabled = true;
            _text = string.Empty;
        ...
        /// </summary>
        CheckState IEasyCommand.CheckState
        {
    ...
    /// <summary>
    /// Manages a collection of EasyTaskDialogCommand instances.
    /// </summary>
    public class EasyTaskDialogCommandCollection : TypedCollection<EasyTaskDialogCommand>
    {
        #region Public
        /// <summary>
        ...
        public override EasyTaskDialogCommand this[string name]
        {
            get
            {
                if (!string.IsNullOrEmpty(name))
                {
                    foreach (EasyTaskDialogCommand item in this)
                    {
