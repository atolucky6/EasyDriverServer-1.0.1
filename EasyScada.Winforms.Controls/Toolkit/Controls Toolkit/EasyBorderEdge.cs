...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasyBorderEdgeDesigner))]
    [ToolboxBitmap(typeof(EasyBorderEdge), "ToolkitBitmaps.EasyBorderEdge.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyBorderEdge : VisualControlBase
	{
		...
		#region Identity
		/// <summary>
        /// Initialize a new instance of the EasyBorderEdge class.
		/// </summary>
        public EasyBorderEdge()
		{
