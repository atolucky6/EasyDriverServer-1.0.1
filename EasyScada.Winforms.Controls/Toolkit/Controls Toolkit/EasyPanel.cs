...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasyPanelDesigner))]
    [ToolboxBitmap(typeof(EasyPanel), "ToolkitBitmaps.EasyPanel.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyPanel : VisualPanel
	{
		...
		#region Identity
		/// <summary>
		/// Initialize a new instance of the EasyPanel class.
		/// </summary>
		public EasyPanel()
		{
        ...
        public EasyPanel(PaletteDoubleRedirect stateCommon,
		...
		#region Protected
        /// <summary>
        /// Gets access to the view element used to draw the EasyPanel.
        /// </summary>
