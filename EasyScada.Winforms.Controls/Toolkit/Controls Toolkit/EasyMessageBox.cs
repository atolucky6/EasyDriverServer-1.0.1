...
namespace EasyScada.Winforms.Controls
{
    ...
    public class EasyMessageBox : EasyForm
    {
        #region Types
        ...
        private EasyPanel _panelMessageText;
        private EasyWrapLabel _messageText;
        private EasyPanel _panelMessageIcon;
        ...
        private EasyBorderEdge borderEdge;
        private HelpInfo _helpInfo;
        #endregion

        #region Identity
        static EasyMessageBox()
        {
            _osMajorVersion = Environment.OSVersion.Version.Major;
        }

        private EasyMessageBox(string text, string caption,
                                                 ...
                                                 HelpInfo helpInfo)
        {
            ...
            using (EasyMessageBox kmb = new EasyMessageBox(text, caption, buttons, icon, defaultButton, options, helpInfo))
            {
                if (showOwner == null)
        ...
        private void UpdateButtons()
        {
            switch (_buttons)
            {
                ...
                case MessageBoxButtons.YesNoCancel:
                    _button1.Text = EasyManager.Strings.Yes;
                    _button2.Text = EasyManager.Strings.No;
                    _button3.Text = EasyManager.Strings.Cancel;
                    _button1.DialogResult = DialogResult.Yes;
                    _button2.DialogResult = DialogResult.No;
                    _button3.DialogResult = DialogResult.Cancel;
                    break;
                case MessageBoxButtons.RetryCancel:
                    _button1.Text = EasyManager.Strings.Retry;
                    _button2.Text = EasyManager.Strings.Cancel;
                ...
                case MessageBoxButtons.AbortRetryIgnore:
                    _button1.Text = EasyManager.Strings.Abort;
                    _button2.Text = EasyManager.Strings.Retry;
                    _button3.Text = EasyManager.Strings.Ignore;
        ...
        private void InitializeComponent()
        {
            ...
            this._panelMessageText = new EasyScada.Winforms.Controls.EasyPanel();
            this._messageText = new EasyScada.Winforms.Controls.EasyWrapLabel();
            this._panelMessageIcon = new EasyScada.Winforms.Controls.EasyPanel();
            this._messageIcon = new System.Windows.Forms.PictureBox();
            this._panelButtons = new EasyScada.Winforms.Controls.EasyPanel();
            this.borderEdge = new EasyScada.Winforms.Controls.EasyBorderEdge();
            this._button3 = new EasyScada.Winforms.Controls.EasyMessageBox.MessageButton();
            this._button1 = new EasyScada.Winforms.Controls.EasyMessageBox.MessageButton();
            this._button2 = new EasyScada.Winforms.Controls.EasyMessageBox.MessageButton();
            ...
            this._messageText.LabelStyle = EasyScada.Winforms.Controls.LabelStyle.NormalPanel;
            ...
            // borderEdge
            // 
            this.borderEdge.BorderStyle = EasyScada.Winforms.Controls.PaletteBorderStyle.HeaderPrimary;
            ...
            this.borderEdge.Text = "easyBorderEdge1";
            // 
            // _button3
            // 
