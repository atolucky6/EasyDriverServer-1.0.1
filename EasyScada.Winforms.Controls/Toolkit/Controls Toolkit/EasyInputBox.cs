...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyInputBox), "ToolboxBitmaps.EasyInputBox.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    public class EasyInputBox : EasyForm
    {
        ...
        #region Identity
        private EasyInputBox(string prompt, 
                                string caption,
                                           ...
                                           string defaultResponse)
        {
            ...
            using (EasyInputBox ib = new EasyInputBox(prompt, caption, defaultResponse))
            {
                if (showOwner == null)
        ...
        private void InitializeComponent()
        {
            ...
            this._labelPrompt.LabelStyle = EasyScada.Winforms.Controls.LabelStyle.NormalPanel;
