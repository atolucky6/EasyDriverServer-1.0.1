...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasyBreadCrumbDesigner))]
    [ToolboxBitmap(typeof(EasyBreadCrumb), "ToolkitBitmaps.EasyBreadCrumb.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyBreadCrumb : VisualSimpleBase,
                                    ISupportInitializeNotification
	{
        ...
        { 
            ...
            public BreadCrumbButtonSpecCollection(EasyBreadCrumb owner)
                : base(owner)
            {
            }
            #endregion
        ...
        private EasyBreadCrumbItem _rootItem;
        private EasyBreadCrumbItem _selectedItem;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyBreadCrumb class.
		/// </summary>
        public EasyBreadCrumb()
		{
            ...
            _rootItem = new EasyBreadCrumbItem("Root");
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyBreadCrumbItem RootItem
        {
        ...
        [DefaultValue(null)]
        public EasyBreadCrumbItem SelectedItem
        {
        ...
        private void OnCrumbItemChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == "Items")
            {
                ...
                if (SelectedItem != null)
                {
                    ...
                    EasyBreadCrumbItem temp = SelectedItem;
                    while ((temp != null) && (temp != RootItem))
                        temp = temp.Parent;
