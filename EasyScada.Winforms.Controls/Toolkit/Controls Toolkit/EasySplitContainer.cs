...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasySplitContainerDesigner))]
    [ToolboxBitmap(typeof(EasySplitContainer), "ToolkitBitmaps.EasySplitContainer.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasySplitContainer : VisualControlContainment,
                                         ISeparatorSource
    {
        ...
        private EasySplitterPanel _panel1;
        private EasySplitterPanel _panel2;
        ...
        #region Identity
        /// <summary>
		/// Initialize a new instance of the EasySplitContainer class.
		/// </summary>
		public EasySplitContainer()
		{
            ...
            _panel1 = new EasySplitterPanel(this);
            _panel2 = new EasySplitterPanel(this);

            // Add both panels to the controls collection
            ((EasyReadOnlyControls)Controls).AddInternal(_panel1);
            ((EasyReadOnlyControls)Controls).AddInternal(_panel2);
        }
        ...
        /// <summary>
        /// Gets access to the first easy splitter panel.
        /// </summary>
        [Localizable(false)]
        [Category("Appearance")]
        [Description("The Left or Top panel in the EasySplitContainer.")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasySplitterPanel Panel1
        {
            get { return _panel1; }
        }
        ...
        /// <summary>
        /// Gets access to the second easy splitter panel.
        /// </summary>
        [Localizable(false)]
        [Category("Appearance")]
        [Description("The Right or Bottom panel in the EasySplitContainer.")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasySplitterPanel Panel2
        {
            get { return _panel2; }
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating the horizontal or vertical orientation of the EasySplitContainer panels.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the EasySplitContainer.
        /// </summary>
