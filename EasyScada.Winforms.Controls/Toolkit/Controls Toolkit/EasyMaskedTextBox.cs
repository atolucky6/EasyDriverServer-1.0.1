...
{
	/// <summary>
    /// Provide a MaskedTextBox with Easy styling applied.
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("MaskInputRejected")]
	[DefaultProperty("Mask")]
    [Designer(typeof(EasyMaskedTextBoxDesigner))]
    [ToolboxBitmap(typeof(EasyMaskedTextBox), "ToolkitBitmaps.EasyMaskedTextBox.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyMaskedTextBox : VisualControlBase,
                                        IContainedInputControl
    {
        ...
        private class InternalMaskedTextBox : MaskedTextBox
        {
            ...
            private EasyMaskedTextBox _easyMaskedTextBox;
            ...
            /// </summary>
            /// <param name="easyMaskedTextBox">Reference to owning control.</param>
            public InternalMaskedTextBox(EasyMaskedTextBox easyMaskedTextBox)
            {
                _easyMaskedTextBox = easyMaskedTextBox;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_easyMaskedTextBox.InTransparentDesignMode)
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _easyMaskedTextBox.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    g.TextRenderingHint = CommonHelper.PaletteTextHintToRenderingHint(_easyMaskedTextBox.StateDisabled.PaletteContent.GetContentShortTextHint(PaletteState.Disabled));
                                    ...
                                    switch (_easyMaskedTextBox.TextAlign)
                                    {
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(ForeColor))
                                            g.DrawString(drawText, _easyMaskedTextBox.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
                    ...
                    case PI.WM_CONTEXTMENU:
                        ...
                        if (_easyMaskedTextBox.EasyContextMenu != null)
                        {
                            ...
                            _easyMaskedTextBox.EasyContextMenu.Show(_easyMaskedTextBox, mousePt);
        ...
        { 
            ...
            public MaskedTextBoxButtonSpecCollection(EasyMaskedTextBox owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyMaskedTextBox class.
		/// </summary>
        public EasyMaskedTextBox()
        {
            ...
            ((EasyReadOnlyControls)Controls).AddInternal(_maskedTextBox);
        }
