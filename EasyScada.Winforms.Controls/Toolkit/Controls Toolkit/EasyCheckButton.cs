...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasyCheckButtonDesigner))]
    ...
    public class EasyCheckButton : ThemedButton
	{
		...
		#region Identity
		/// <summary>
        /// Initialize a new instance of the EasyCheckButton class.
		/// </summary>
        public EasyCheckButton()
		{
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the EasyCheckButton is in the checked state. 
        /// </summary>
        [Category("Appearance")]
        ...
        [DefaultValue(null)]
        public override IEasyCommand EasyCommand
        {
            get { return base.EasyCommand; }

            set
            {
                if (base.EasyCommand != value)
                {
                    if (base.EasyCommand == null)
                        _wasChecked = Checked;

                    base.EasyCommand = value;
        ...
        protected override void OnEasyCommandChanged(EventArgs e)
        {
            // Let base class update with base button properties
            base.OnEasyCommandChanged(e);

            // Update the check button specific properties from the command
            if (EasyCommand != null)
                Checked = EasyCommand.Checked;
        }
