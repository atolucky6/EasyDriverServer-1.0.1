...
{
	/// <summary>
    /// Display a windows forms label but with Easy palette text and font settings.
	/// </summary>
	[ToolboxItem(true)]
	[DefaultProperty("Text")]
    [DesignerCategory("code")]
    [Designer(typeof(EasyWrapLabelDesigner))]
    [ToolboxBitmap(typeof(EasyWrapLabel), "ToolkitBitmaps.EasyWrapLabel.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyWrapLabel : Label
    {
        #region Static Field
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyWrapLabel class.
        /// </summary>
        public EasyWrapLabel()
        {
