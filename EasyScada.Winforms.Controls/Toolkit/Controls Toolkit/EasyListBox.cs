...
{
	/// <summary>
    /// Provide a ListBox with Easy styling applied.
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("SelectedIndexChanged")]
    [DefaultProperty("Items")]
    [Designer(typeof(EasyListBoxDesigner))]
    [ToolboxBitmap(typeof(EasyListBox), "ToolkitBitmaps.EasyListBox.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyListBox : VisualControlBase,
                                  IContainedInputControl
    {
        ...
        private class InternalListBox : ListBox
        {
            ...
            private EasyListBox _easyListBox;
            ...
            /// </summary>
            /// <param name="easyListBox">Reference to owning control.</param>
            public InternalListBox(EasyListBox easyListBox)
            {
                SetStyle(ControlStyles.ResizeRedraw, true);

                _easyListBox = easyListBox;
                _mouseIndex = -1;
            ...
            protected override void OnLayout(LayoutEventArgs levent)
            {
                ...
                using (ViewLayoutContext context = new ViewLayoutContext(_viewManager, this, _easyListBox, _easyListBox.Renderer))
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _easyListBox.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    if (hBitmap != IntPtr.Zero)
                    {
                        try
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(_screenDC))
                            {
                                ...
                                using (ViewLayoutContext context = new ViewLayoutContext(this, _easyListBox.Renderer))
                                {
                                    context.DisplayRectangle = realRect;
                                    _drawPanel.Layout(context);
                                }

                                using (RenderContext context = new RenderContext(this, _easyListBox, g, realRect, _easyListBox.Renderer))
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyListBox class.
        /// </summary>
        public EasyListBox()
        {
        ...
        /// <summary>
        /// Gets or sets the zero-based index of the currently selected item in a EasyListBox.
        /// </summary>
        [Bindable(true)]
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets a collection that contains the zero-based indexes of all currently selected items in the EasyListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets or sets the currently selected item in the EasyListBox.
        /// </summary>
        [Bindable(true)]
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets a collection containing the currently selected items in the EasyListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        /// <summary>
        /// Gets or sets the index of the first visible item in the EasyListBox.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public int TopIndex
        ...
        /// <summary>
        /// Gets or sets the width by which the horizontal scroll bar of a EasyListBox can scroll. 
        /// </summary>
        [Category("Behavior")]
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Indicates whether the EasyListBox will display a horizontal scrollbar for items beyond the right edge of the EasyListBox.")]
        [Localizable(true)]
        [DefaultValue(false)]
        ...
        /// <summary>
        /// Gets or sets the selection mode of the EasyListBox control.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the items in the EasyListBox are sorted alphabetically.
        /// </summary>
        [Category("Behavior")]
        ...
        /// <summary>
        /// Gets the items of the EasyListBox. 
        /// </summary>
        [Category("Data")]
        [Description("The items in the EasyListBox.")]
        ...
        /// <summary>
        /// Unselects all items in the EasyListBox.
        /// </summary>
        ...
        /// <summary>
        /// Returns the height of an item in the EasyListBox.
        /// </summary>
        ...
        /// <summary>
        /// Returns the bounding rectangle for an item in the EasyListBox.
        /// </summary>
        ...
        /// <returns>true if the specified item is currently selected in the EasyListBox; otherwise, false.</returns>
        ...
        /// <summary>
        /// Selects or clears the selection for the specified item in a EasyListBox. 
        /// </summary>
        /// <param name="index">The zero-based index of the item in a EasyListBox to select or clear the selection for.</param>
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the EasyListBox.
        /// </summary>
