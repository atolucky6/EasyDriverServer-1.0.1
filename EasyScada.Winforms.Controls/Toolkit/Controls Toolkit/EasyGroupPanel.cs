...
{
	/// <summary>
    /// Special panel used in the EasyGroup and EasyHeaderGroup controls.
	/// </summary>
	[ToolboxItem(false)]
    [Designer(typeof(EasyGroupPanelDesigner))]
    [ToolboxBitmap(typeof(EasyGroupPanel), "ToolkitBitmaps.EasyGroupPanel.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public sealed class EasyGroupPanel : EasyPanel
	{
		...
		#region Identity
        /// <summary>
        /// Initialize a new instance of the EasyGroupPanel class.
        /// </summary>
        ...
        public EasyGroupPanel(Control alignControl,
		...
		/// <summary>
		/// Gets or sets the height of the EasyGroupPanel. 
		/// </summary>
        [Browsable(false)]
        ...
        protected override Control TransparentParent
        {
            get 
            {
                ...
                // The EasyGroupPanel is always a child within another 
                // Easy control that should be considered the actual 
