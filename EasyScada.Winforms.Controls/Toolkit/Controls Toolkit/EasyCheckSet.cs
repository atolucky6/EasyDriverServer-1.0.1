...
{
    /// <summary>
    /// Enforce mutual exclusive for a group of EasyCheckButton controls.
    /// </summary>
    [ToolboxItem(true)]
    [DefaultEvent("CheckedButtonChanged")]
    [DefaultProperty("CheckButtons")]
    [Designer(typeof(EasyCheckSetDesigner))]
    [ToolboxBitmap(typeof(EasyCheckSet), "ToolkitBitmaps.EasyCheckSet.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyCheckSet : Component, ISupportInitialize
    {
        #region Type Definitions
        /// <summary>
        /// Manages a collection of EasyCheckButton references.
        /// </summary>
        public class EasyCheckButtonCollection : CollectionBase
        {
            #region Instance Fields
            private EasyCheckSet _owner;
            #endregion

            #region Identity
            /// <summary>
            /// Initialize a new instance of the EasyCheckButtonCollection class.
            /// </summary>
            /// <param name="owner">Owning component</param>
            public EasyCheckButtonCollection(EasyCheckSet owner)
            {
            ...
            #region Public
            /// <summary>
            /// Adds the specifies EasyCheckButton to the collection.
            /// </summary>
            /// <param name="checkButton">The EasyCheckButton object to add to the collection.</param>
            /// <returns>The index of the new entry.</returns>
            public int Add(EasyCheckButton checkButton)
            {
            ...
            /// <summary>
            /// Determines whether a EasyCheckButton is in the collection.
            /// </summary>
            /// <param name="checkButton">The EasyCheckButton to locate in the collection.</param>
            /// <returns>True if found in collection; otherwise false.</returns>
            public bool Contains(EasyCheckButton checkButton)
            {
                return base.List.Contains(checkButton);
            }

            /// <summary>
            /// Returns the index of the EasyCheckButton reference.
            /// </summary>
            /// <param name="checkButton">The EasyCheckButton to locate.</param>
            /// <returns>Index of reference; otherwise -1.</returns>
            public int IndexOf(EasyCheckButton checkButton)
            {
                return base.List.IndexOf(checkButton);
            }

            /// <summary>
            /// Inserts a EasyCheckButton reference into the collection at the specified location.
            /// </summary>
            /// <param name="index">Index of position to insert.</param>
            /// <param name="checkButton">The EasyCheckButton reference to insert.</param>
            public void Insert(int index, EasyCheckButton checkButton)
            {
                Debug.Assert(checkButton != null);
            ...
            /// <summary>
            /// Removes a EasyCheckButton from the collection.
            /// </summary>
            /// <param name="checkButton">The EasyCheckButton to remove.</param>
            public void Remove(EasyCheckButton checkButton)
            {
                Debug.Assert(checkButton != null);
            ...
            /// <summary>
            /// Gets the EasyCheckButton at the specified index.
            /// </summary>
            /// <param name="index">Index of entry to return.</param>
            /// <returns>Reference of EasyCheckButton instance.</returns>
            public EasyCheckButton this[int index]
            {
                get
                {
                    if ((index < 0) || (index > Count))
                    ...
                    return (EasyCheckButton)base.List[index];
                }
            }
            #endregion
            ...
            {
                foreach(EasyCheckButton checkButton in base.List)
            ...
            {
                _owner.CheckButtonAdded(value as EasyCheckButton);
            ...
            {
                _owner.CheckButtonRemoved(value as EasyCheckButton);
            ...
            {
                _owner.CheckButtonRemoved(oldValue as EasyCheckButton);
                _owner.CheckButtonAdded(newValue as EasyCheckButton);
        ...
        private EasyCheckButton _checkedButton;
        private EasyCheckButtonCollection _checkButtons;
        #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyCheckSet class.
        /// </summary>
        public EasyCheckSet()
        {
            _checkButtons = new EasyCheckButtonCollection(this);
        }
        ...
        public EasyCheckSet(IContainer container)
            : this()
        {
        ...
        [TypeConverter(typeof(EasyCheckedButtonConverter))]
        [DefaultValue(null)]
        public EasyCheckButton CheckedButton
        {
            ...
            set
            {
                if (_checkedButton != value)
                {
                    ...
                    if ((value != null) && !CheckButtons.Contains(value))
                        throw new ArgumentOutOfRangeException("value", "Provided value is not a EasyCheckButton associated with this set.");
        ...
        /// <summary>
        /// Gets access to the collection of EasyCheckButton referencs.
        /// </summary>
        [Category("Behavior")]
        [Description("Determine which of the associated buttons is checked.")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        [Editor("EasyScada.Winforms.Controls.EasyCheckButtonCollectionEditor, EasyScada.Winforms.Controls, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e", typeof(UITypeEditor))]
        [RefreshProperties(RefreshProperties.All)]
        public EasyCheckButtonCollection CheckButtons
        {
        ...
        private void CheckButtonAdded(EasyCheckButton checkButton)
        {
        ...
        private void CheckButtonRemoved(EasyCheckButton checkButton)
        {
        ...
        private void OnCheckedChanging(object sender, CancelEventArgs e)
        {
            ...
            if (!_ignoreEvents)
            {
                ...
                EasyCheckButton checkedButton = (EasyCheckButton)sender;
