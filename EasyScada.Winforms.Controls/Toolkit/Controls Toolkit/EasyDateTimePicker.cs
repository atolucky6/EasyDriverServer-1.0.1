...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasyDateTimePickerDesigner))]
    [ToolboxBitmap(typeof(EasyDateTimePicker), "ToolkitBitmaps.EasyDateTimePicker.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyDateTimePicker : VisualControlBase, 
                                         IContentValues
	{
        ...
        { 
            ...
            public DateTimePickerButtonSpecCollection(EasyDateTimePicker owner)
                : base(owner)
            {
            }
            #endregion
        ...
        private EasyContextMenuMonthCalendar _kmc;
        ...
        /// </summary>
        [Category("Action")]
        [Description("Event raised when the value of the Value property is changed on EasyDateTimePicker.")]
        ...
        /// </summary>
        [Category("Action")]
        [Description("Event raised when the value of the ValueNullable property is changed on EasyDateTimePicker.")]
        ...
        /// </summary>
        [Category("Action")]
        [Description("Event raised when the value of the ActiveFragment property is changed on EasyDateTimePicker.")]
        ...
        [Description("Event raised when the value of the Checked property is changed on EasyDateTimePicker.")]
        ...
        /// </summary>
        [Category("Property Changed")]
        [Description("Event raised when the value of the Format property is changed on EasyDateTimePicker.")]
        ...
        /// </summary>
        [Category("Property Changed")]
        [Description("Event raised when the value of the RightToLeftLayout property is changed on EasyDateTimePicker.")]
        public event EventHandler RightToLeftLayoutChanged;
        #endregion

        #region Identity
        /// <summary>
		/// Initialize a new instance of the EasyHeader class.
		/// </summary>
		public EasyDateTimePicker()
		{
        ...
        /// </summary>
        [Category("Appearance")]
        [Description("Alignment of the drop-down calendar on the EasyDateTimePicker control.")]
        ...
        private void OnDropDownClick(object sender, EventArgs e)
        {
            ...
            if (!_inRibbonDesignMode)
            {
                ...
                // Create a new easy context menu each time we drop the menu
                ...
                _kmc = new EasyContextMenuMonthCalendar();
                ...
                DateTimePickerDropArgs dtpda = new DateTimePickerDropArgs(kcm,
                                                                          (DropDownAlign == LeftRightAlignment.Left ? EasyContextMenuPositionH.Left : EasyContextMenuPositionH.Right),
                                                                          EasyContextMenuPositionV.Below);
                ...
                if (!dtpda.Cancel)
                {
                    if (dtpda.EasyContextMenu != null)
                    {
                        ...
                        if (CommonHelper.ValidEasyContextMenu(dtpda.EasyContextMenu))
                        {
                            ...
                            dtpda.EasyContextMenu.Closed += new ToolStripDropDownClosedEventHandler(OnEasyContextMenuClosed);
                            dtpda.EasyContextMenu.Show(this, screenRect, dtpda.PositionH, dtpda.PositionV);
                            return;
                        }
                    }
                }
    ...
    /// <summary>
    /// Specialized implementation of the EasyContextMenu for use with the EasyDateTimePicker.
    /// </summary>
    [ToolboxItem(false)]
    [DesignerCategory("code")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class DTPContextMenu : EasyContextMenu
    {
        #region Instance Fields
        ...
        /// </summary>
        /// <param name="dropScreenRect">Screen rectangle of the drop down button on the EasyDateTimePicker.</param>
        ...
        /// </summary>
        /// <param name="kcm">Owning EasyContextMenu instance.</param>
        ...
        protected override VisualContextMenu CreateContextMenu(EasyContextMenu kcm,
                                                               IPalette palette,
                                                               PaletteMode paletteMode,
                                                               PaletteRedirect redirector,
                                                               PaletteRedirectContextMenu redirectorImages,
                                                               EasyContextMenuCollection items,
                                                               Boolean enabled,
