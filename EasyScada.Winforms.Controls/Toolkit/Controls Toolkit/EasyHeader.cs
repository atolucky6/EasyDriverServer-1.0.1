...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasyHeaderDesigner))]
    [ToolboxBitmap(typeof(EasyHeader), "ToolkitBitmaps.EasyHeader.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyHeader : VisualSimpleBase
	{
        ...
        { 
            ...
            public HeaderButtonSpecCollection(EasyHeader owner)
                : base(owner)
            {
            }
            #endregion
