...
{
	/// <summary>
    /// Provide a RichTextBox with Easy styling applied.
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("TextChanged")]
	[DefaultProperty("Text")]
    [Designer(typeof(EasyRichTextBoxDesigner))]
    [ToolboxBitmap(typeof(EasyRichTextBox), "ToolkitBitmaps.EasyRichTextBox.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyRichTextBox : VisualControlBase,
                                      IContainedInputControl
    {
        ...
        private class InternalRichTextBox : RichTextBox
        {
            ...
            private EasyRichTextBox _easyRichTextBox;
            ...
            /// </summary>
            /// <param name="easyRichTextBox">Reference to owning control.</param>
            public InternalRichTextBox(EasyRichTextBox easyRichTextBox)
            {
                _easyRichTextBox = easyRichTextBox;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_easyRichTextBox.InTransparentDesignMode)
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _easyRichTextBox.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    case PI.WM_CONTEXTMENU:
                        ...
                        if (_easyRichTextBox.EasyContextMenu != null)
                        {
                            ...
                            _easyRichTextBox.EasyContextMenu.Show(_easyRichTextBox, mousePt);
        ...
        { 
            ...
            public RichTextBoxButtonSpecCollection(EasyRichTextBox owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyRichTextBox class.
		/// </summary>
        public EasyRichTextBox()
        {
            ...
            ((EasyReadOnlyControls)Controls).AddInternal(_richTextBox);
        ...
        /// <summary>
        /// Defines the current scaling factor of the EasyRichTextBox display; 1.0 is normal viewing.
        /// </summary>
        [Category("Behavior")]
        [Description("Defines the current scaling factor of the EasyRichTextBox display; 1.0 is normal viewing.")]
        [DefaultValue(1.0f)]
        [Localizable(true)]
        ...
        /// <summary>
        /// Saves the contents of the EasyRichTextBox to a specific type of file.
        /// </summary>
        /// <param name="path">The name and location of the file to save.</param>
        /// <param name="fileType">One of the RichTextBoxStreamType values.</param>
