...
{
	/// <summary>
    /// Provide a NumericUpDown with Easy styling applied.
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("ValueChanged")]
	[DefaultProperty("Value")]
    [Designer(typeof(EasyNumericUpDownDesigner))]
    [ToolboxBitmap(typeof(EasyNumericUpDown), "ToolkitBitmaps.EasyNumericUpDown.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyNumericUpDown : VisualControlBase,
                                        IContainedInputControl
    {
        ...
        private class InternalNumericUpDown : NumericUpDown
        {
            ...
            private EasyNumericUpDown _easyNumericUpDown;
            ...
            /// </summary>
            /// <param name="easyNumericUpDown">Reference to owning control.</param>
            public InternalNumericUpDown(EasyNumericUpDown easyNumericUpDown)
            {
                _easyNumericUpDown = easyNumericUpDown;
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case PI.WM_NCHITTEST:
                        if (_easyNumericUpDown.InTransparentDesignMode)
                    ...
                    case PI.WM_MOUSELEAVE:
                        ...
                        MouseOver = false;
                        _easyNumericUpDown.PerformNeedPaint(true);
                        Invalidate();
                        base.WndProc(ref m);
                        break;
                    ...
                    case PI.WM_CONTEXTMENU:
                        ...
                        if (_easyNumericUpDown.EasyContextMenu != null)
                        {
                            ...
                            _easyNumericUpDown.EasyContextMenu.Show(_easyNumericUpDown, mousePt);
        ...
        private class SubclassEdit : NativeWindow
        {
            ...
            /// </summary>
            protected EasyNumericUpDown NumericUpDown
            {
                get { return _easyNumericUpDown; }
            }
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    ...
                    case PI.WM_PAINT:
                        {
                            ...
                            using (Graphics g = Graphics.FromHdc(hdc))
                            {
                                ...
                                else
                                {
                                    ...
                                    g.TextRenderingHint = CommonHelper.PaletteTextHintToRenderingHint(_easyNumericUpDown.StateDisabled.PaletteContent.GetContentShortTextHint(PaletteState.Disabled));
                                    ...
                                    switch (_easyNumericUpDown.TextAlign)
                                    {
                                        case HorizontalAlignment.Left:
                                            if (_easyNumericUpDown.RightToLeft == RightToLeft.Yes)
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(_internalNumericUpDown.ForeColor))
                                            g.DrawString(_internalNumericUpDown.Text, _easyNumericUpDown.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
                    ...
                    case PI.WM_CONTEXTMENU:
                        // Only interested in overriding the behavior when we have a easy context menu...
                        if (NumericUpDown.EasyContextMenu != null)
                        {
                            // Extract the screen mouse position (if might not actually be provided)
                            Point mousePt = new Point(PI.LOWORD(m.LParam), PI.HIWORD(m.LParam));
                            ...
                            // Show the context menu
                            NumericUpDown.EasyContextMenu.Show(NumericUpDown, mousePt);
        ...
        private class SubclassButtons : SubclassEdit, IContentValues, IDisposable
        {
            ...
            public SubclassButtons(IntPtr buttonsPtr,
                                   EasyNumericUpDown easyNumericUpDown,
                                   InternalNumericUpDown internalNumericUpDown)
                : base(buttonsPtr, easyNumericUpDown, internalNumericUpDown)
            {
            ...
            private void DrawUpDownButtons(Graphics g, Rectangle clientRect)
            {
                ...
                if (_viewButton == null)
                {
                    // Create helper object to get all values from the EasyNumericUpDown redirector
        ...
        { 
            ...
            public NumericUpDownButtonSpecCollection(EasyNumericUpDown owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyNumericUpDown class.
		/// </summary>
        public EasyNumericUpDown()
        {
            ...
            ((EasyReadOnlyControls)Controls).AddInternal(_numericUpDown);
        }
