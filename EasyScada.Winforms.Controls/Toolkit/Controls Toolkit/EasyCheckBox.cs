...
{
	/// <summary>
    /// Display check box with text and images with the styling features of the Easy Toolkit
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("CheckedChanged")]
	[DefaultProperty("Text")]
    [Designer(typeof(EasyCheckBoxDesigner))]
    [ToolboxBitmap(typeof(EasyCheckBox), "ToolkitBitmaps.EasyCheckBox.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyCheckBox : VisualSimpleBase, IContentValues
	{
		...
		#region Identity
        /// <summary>
        /// Initialize a new instance of the EasyCheckBox class.
		/// </summary>
        public EasyCheckBox()
		{
        ...
        protected virtual void OnCheckStateChanged(EventArgs e)
        {
            ...
            if (EasyCommand != null)
                EasyCommand.CheckState = CheckState;
        }
        ...
        protected virtual void OnEasyCommandChanged(EventArgs e)
        {
            ...
            if (EasyCommand != null)
            {
                ...
                CheckState = EasyCommand.CheckState;
            }
