...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasyGroupBoxDesigner))]
    [ToolboxBitmap(typeof(EasyGroupBox), "ToolkitBitmaps.EasyGroupBox.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyGroupBox : VisualControlContainment
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyGroupBox class.
		/// </summary>
        public EasyGroupBox()
		{
            // Set default values
