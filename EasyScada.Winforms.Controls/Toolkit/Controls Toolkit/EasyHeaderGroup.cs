...
{
	/// <summary>
    /// Combines the benefits of the EasyHeader and the EasyGroup into one.
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("Paint")]
	[DefaultProperty("ValuesPrimary")]
    [Designer(typeof(EasyHeaderGroupDesigner))]
    [ToolboxBitmap(typeof(EasyHeaderGroup), "ToolkitBitmaps.EasyHeaderGroup.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyHeaderGroup : VisualControlContainment
    {
        ...
        public class HeaderGroupButtonSpecCollection : ButtonSpecCollection<ButtonSpecHeaderGroup>
        {
            ...
            public HeaderGroupButtonSpecCollection(EasyHeaderGroup owner)
                : base(owner)
            {
            }
            #endregion
        ...
        #region Identity
        /// <summary>
		/// Initialize a new instance of the EasyHeaderGroup class.
		/// </summary>
		public EasyHeaderGroup()
		{
            ...
            _panel = new EasyGroupPanel(this, _stateCommon, _stateDisabled, _stateNormal, new NeedPaintHandler(OnGroupPanelPaint));
            ...
            ((EasyReadOnlyControls)Controls).AddInternal(_panel);
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the EasyHeaderGroup.
        /// </summary>
