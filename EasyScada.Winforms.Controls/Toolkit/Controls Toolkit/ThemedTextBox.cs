...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(ThemedTextBoxDesigner))]
    [ToolboxBitmap(typeof(ThemedTextBox), "ToolkitBitmaps.EasyTextBox.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class ThemedTextBox : VisualControlBase,
                                  IContainedInputControl
    {
        ...
        private class InternalTextBox : TextBox
        {
            ...
            private ThemedTextBox _easyTextBox;
            ...
            public InternalTextBox(ThemedTextBox easyTextBox)
            {
        ...
        { 
            ...
            public TextBoxButtonSpecCollection(ThemedTextBox owner)
                : base(owner)
            {
            }
            #endregion
