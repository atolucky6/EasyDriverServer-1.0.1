...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(ThemedButtonDesigner))]
    [ToolboxBitmap(typeof(ThemedButton), "ToolkitBitmaps.EasyButton.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class ThemedButton : VisualSimpleBase, IButtonControl, IContentValues
	{
