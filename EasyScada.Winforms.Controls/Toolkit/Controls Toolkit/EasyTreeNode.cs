...
{
    /// <summary>
    /// Easy extension of the TreeNode allowing extra information to be drawn.
    /// </summary>
    [ToolboxItem(false)]
    public class EasyTreeNode : TreeNode
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyTreeNode class.
        /// </summary>
        public EasyTreeNode()
        {
            Init();
        ...
        public EasyTreeNode(string text)
            : base(text)
        {
            Init();
        }
        ...
        public EasyTreeNode(string text, TreeNode[] children)
            : base(text, children)
        {
            Init();
        }
        ...
        public EasyTreeNode(string text, int imageIndex, int selectedImageIndex)
        ...
        /// <param name="selectedImageIndex">The index value of System.Drawing.Image to display when the tree node is selected.</param>
        /// <param name="children">An array of child System.Windows.Forms.TreeNode objects.</param>
        public EasyTreeNode(string text, int imageIndex, int selectedImageIndex, TreeNode[] children)
