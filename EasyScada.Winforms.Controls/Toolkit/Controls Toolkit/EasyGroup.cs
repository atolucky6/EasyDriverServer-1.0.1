...
{
	/// <summary>
    /// Group related controls together with Easy Toolkit styling.
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("Paint")]
	[DefaultProperty("GroupBackStyle")]
    [Designer(typeof(EasyGroupDesigner))]
    [ToolboxBitmap(typeof(EasyGroup), "ToolkitBitmaps.EasyGroup.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyGroup : VisualControlContainment
	{
		...
		#region Identity
		/// <summary>
		/// Initialize a new instance of the EasyGroup class.
		/// </summary>
		public EasyGroup()
		{            
        ...
        /// <summary>
        /// Creates a new instance of the control collection for the EasyGroup.
        /// </summary>
