...
{
	/// <summary>
    /// Display radio button with text and images with the styling features of the Easy Toolkit
	/// </summary>
	[ToolboxItem(true)]
    [DefaultEvent("CheckedChanged")]
	[DefaultProperty("Text")]
    [Designer(typeof(EasyRadioButtonDesigner))]
    [ToolboxBitmap(typeof(EasyRadioButton), "ToolkitBitmaps.EasyRadioButton.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyRadioButton : VisualSimpleBase
	{
            ...
            if (AutoCheck && Checked)
            {
                ...
                if (parent != null)
                {
                    ...
                    foreach (Control c in parent.Controls)
                    {
                        ...
                        if ((c != this) && (c is EasyRadioButton))
                        {
                            // Cast to correct type
                            EasyRadioButton rb = (EasyRadioButton)c;
