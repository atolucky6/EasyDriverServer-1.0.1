...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(ThemedLabelDesigner))]
    [ToolboxBitmap(typeof(ThemedLabel), "ToolkitBitmaps.EasyLabel.bmp")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class ThemedLabel : VisualSimpleBase, IContentValues
	{
