...
namespace EasyScada.Winforms.Controls
{
    ...
    [Designer(typeof(EasyLinkLabelDesigner))]
    ...
    public class EasyLinkLabel : ThemedLabel
	{
		...
		#region Identity
		/// <summary>
        /// Initialize a new instance of the EasyLinkLabel class.
		/// </summary>
        public EasyLinkLabel()
		{
            ...
            _inheritBehavior = new LinkLabelBehaviorInherit(StateNormal, EasyLinkBehavior.AlwaysUnderline);
        ...
        {
            LinkBehavior = EasyLinkBehavior.AlwaysUnderline;
        }

        private bool ShouldSerializeLinkBehavior()
        {
            return (LinkBehavior != EasyLinkBehavior.AlwaysUnderline);
        }
