...
namespace EasyScada.Winforms.Controls
{
    ...
    public class PaletteSparkleBase : PaletteBase
    {
        ...
        private EasyColorTableSparkle _table;
        ...
        public override IRenderer GetRenderer()
        {
            ...
            return EasyManager.RenderSparkle;
        }
        #endregion
        ...
        public override EasyColorTable ColorTable
        {
            ...
            {
                if (_table == null)
                    _table = new EasyColorTableSparkle(_ribbonColors, _sparkleColors, InheritBool.True, this);
