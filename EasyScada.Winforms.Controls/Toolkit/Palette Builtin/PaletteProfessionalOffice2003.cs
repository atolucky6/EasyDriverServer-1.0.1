...
namespace EasyScada.Winforms.Controls
{
    ...
    public class PaletteProfessionalOffice2003 : PaletteProfessionalSystem
	{
        ...
        /// </summary>
        /// <returns>EasyColorTable instance.</returns>
        internal override EasyProfessionalKCT GenerateColorTable()
        {
                ...
                if (VisualStyleInformation.IsEnabledByUser)
                {
                    ...
                    switch (VisualStyleInformation.ColorScheme)
                    {
                        case "NormalColor":
                            ...
                            return new EasyProfessionalKCT(_colorsB, false, this);
                        case "HomeStead":
                            _usingOffice2003 = true;
                            return new EasyProfessionalKCT(_colorsG, false, this);
                        case "Metallic":
                            _usingOffice2003 = true;
                            return new EasyProfessionalKCT(_colorsS, false, this);
                    }
                }
            }
