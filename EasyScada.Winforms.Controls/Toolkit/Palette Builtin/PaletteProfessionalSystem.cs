...
namespace EasyScada.Winforms.Controls
{
	...
	public class PaletteProfessionalSystem : PaletteBase
	{
		...
		private EasyProfessionalKCT _table;
        ...
        public override IRenderer GetRenderer()
        {
            ...
            return EasyManager.RenderProfessional;
        }
        #endregion
        ...
        /// </summary>
        public override EasyColorTable ColorTable
        {
            get { return Table; }
        }

        internal EasyProfessionalKCT Table
        {
            get
            {
        ...
        /// </summary>
        /// <returns>EasyProfessionalKCT instance.</returns>
        internal virtual EasyProfessionalKCT GenerateColorTable()
        {
            // Create the color table to use as the base for getting easy colors
            EasyColorTable kct = new EasyColorTable(this);

            // Always turn off the use of any theme specific colors
            kct.UseSystemColors = true;

            // Calculate the easy specific colors
            Color[] colors = new Color[] { kct.OverflowButtonGradientEnd,   // Header1Begin
                                           kct.OverflowButtonGradientEnd,   // Header1End
                                         };

            // Create a easy extension color table
            return new EasyProfessionalKCT(colors, true, this);
        }
        #endregion
