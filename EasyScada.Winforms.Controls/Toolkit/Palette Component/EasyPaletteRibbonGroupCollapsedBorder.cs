...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteRibbonGroupCollapsedBorder : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteRibbonGroupCollapsedBorder class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteRibbonGroupCollapsedBorder(PaletteRedirect redirect,
