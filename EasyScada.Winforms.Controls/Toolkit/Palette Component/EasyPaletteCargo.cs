...
{
	/// <summary>
	/// Storage of user supplied values not used by Easy.
	/// </summary>
    public class EasyPaletteCargo : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteCargo class.
		/// </summary>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteCargo(NeedPaintHandler needPaint) 
		{
