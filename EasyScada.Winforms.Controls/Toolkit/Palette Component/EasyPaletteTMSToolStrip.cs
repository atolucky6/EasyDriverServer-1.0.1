...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteTMSToolStrip : EasyPaletteTMSBase
    {
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteKCTToolStrip class.
		/// </summary>
        /// <param name="internalKCT">Reference to inherited values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        internal EasyPaletteTMSToolStrip(EasyInternalKCT internalKCT,
