...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteImagesCheckBox : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteImagesCheckBox class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteImagesCheckBox(PaletteRedirect redirect,
