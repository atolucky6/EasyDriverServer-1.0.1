...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteImagesRadioButton : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteImagesRadioButton class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteImagesRadioButton(PaletteRedirect redirect,
