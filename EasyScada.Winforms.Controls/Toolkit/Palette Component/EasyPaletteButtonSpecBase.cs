...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    public class EasyPaletteButtonSpecBase : Storage,
                                                IPaletteButtonSpec
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteButtonSpecBase class.
        /// </summary>
        /// <param name="redirector">Palette redirector for sourcing inherited values.</param>
        internal EasyPaletteButtonSpecBase(PaletteRedirect redirector)
        {
