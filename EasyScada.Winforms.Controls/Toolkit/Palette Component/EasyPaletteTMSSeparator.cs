...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteTMSSeparator : EasyPaletteTMSBase
    {
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteKCTSeparator class.
		/// </summary>
        /// <param name="internalKCT">Reference to inherited values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        internal EasyPaletteTMSSeparator(EasyInternalKCT internalKCT,
