...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteRibbonGroupNormalTitle : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteRibbonGroupNormalTitle class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteRibbonGroupNormalTitle(PaletteRedirect redirect,
