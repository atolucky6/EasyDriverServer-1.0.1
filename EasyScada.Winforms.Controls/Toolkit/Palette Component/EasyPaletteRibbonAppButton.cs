...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteRibbonAppButton : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteRibbonAppButton class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteRibbonAppButton(PaletteRedirect redirect,
