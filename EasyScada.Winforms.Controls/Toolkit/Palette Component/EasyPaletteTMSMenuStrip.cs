...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteTMSMenuStrip : EasyPaletteTMSBase
    {
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteKCTMenuStrip class.
		/// </summary>
        /// <param name="internalKCT">Reference to inherited values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        internal EasyPaletteTMSMenuStrip(EasyInternalKCT internalKCT,
