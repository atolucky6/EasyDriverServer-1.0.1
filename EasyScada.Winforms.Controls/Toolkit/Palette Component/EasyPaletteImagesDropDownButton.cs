...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteImagesDropDownButton : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteImagesDropDownButton class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteImagesDropDownButton(PaletteRedirect redirect,
