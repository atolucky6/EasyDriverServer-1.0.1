...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    public class EasyPaletteButtonSpecTyped : EasyPaletteButtonSpecBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteButtonSpecCommon class.
        /// </summary>
        /// <param name="redirector">Palette redirector for sourcing inherited values.</param>
        internal EasyPaletteButtonSpecTyped(PaletteRedirect redirector)
            : base(redirector)
        {
            _image = null;
            _text = string.Empty;
