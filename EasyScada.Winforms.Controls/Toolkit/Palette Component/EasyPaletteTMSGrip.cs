...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteTMSGrip : EasyPaletteTMSBase
    {
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteKCTGrip class.
		/// </summary>
        /// <param name="internalKCT">Reference to inherited values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        internal EasyPaletteTMSGrip(EasyInternalKCT internalKCT,
