...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteHeaderGroupState : Storage,
                                                  IPaletteMetric
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteHeaderGroupState class.
		/// </summary>
        /// <param name="redirect">Redirection for inheriting values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteHeaderGroupState(PaletteRedirect redirect,
