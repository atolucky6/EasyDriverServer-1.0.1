...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteImagesTreeView : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteImagesTreeView class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteImagesTreeView(PaletteRedirect redirect,
