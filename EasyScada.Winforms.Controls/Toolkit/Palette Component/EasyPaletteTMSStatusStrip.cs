...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteTMSStatusStrip : EasyPaletteTMSBase
    {
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteKCTStatusStrip class.
		/// </summary>
        /// <param name="internalKCT">Reference to inherited values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        internal EasyPaletteTMSStatusStrip(EasyInternalKCT internalKCT,
