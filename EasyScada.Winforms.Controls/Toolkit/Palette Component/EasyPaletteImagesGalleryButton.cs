...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteImagesGalleryButton : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteImagesGalleryButton class.
		/// </summary>
        /// <param name="button">Which button this instance represents.</param>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteImagesGalleryButton(PaletteRibbonGalleryButton button,
