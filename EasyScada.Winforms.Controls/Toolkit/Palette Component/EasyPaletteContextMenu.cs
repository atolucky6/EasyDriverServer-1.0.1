...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    public class EasyPaletteContextMenu : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteContextMenu class.
        /// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        internal EasyPaletteContextMenu(PaletteRedirect redirect,
