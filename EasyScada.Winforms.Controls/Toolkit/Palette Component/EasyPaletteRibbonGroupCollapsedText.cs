...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteRibbonGroupCollapsedText : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteRibbonGroupCollapsedText class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteRibbonGroupCollapsedText(PaletteRedirect redirect,
