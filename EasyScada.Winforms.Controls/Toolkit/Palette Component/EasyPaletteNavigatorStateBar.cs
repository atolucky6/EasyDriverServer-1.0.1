...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteNavigatorStateBar : Storage,
                                                   IPaletteMetric
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteNavigatorStateBar class.
		/// </summary>
        /// <param name="redirect">Redirection for inheriting values.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteNavigatorStateBar(PaletteRedirect redirect,
