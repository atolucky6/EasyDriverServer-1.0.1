...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteRibbonGroupCollapsedFrameBorder : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteRibbonGroupCollapsedFrameBorder class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteRibbonGroupCollapsedFrameBorder(PaletteRedirect redirect,
