...
namespace EasyScada.Winforms.Controls
{
	...
	/// </summary>
    public class EasyPaletteCalendarDay : Storage
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPaletteCalendarDay class.
		/// </summary>
        /// <param name="redirect">Redirector to inherit values from.</param>
        /// <param name="needPaint">Delegate for notifying paint requests.</param>
        public EasyPaletteCalendarDay(PaletteRedirect redirect,
