...
{
    /// <summary>
    /// Extend the ProfessionalColorTable with some Easy specific properties.
    /// </summary>
    public class EasyColorTable : ProfessionalColorTable
    {
        ...
        #region Identity
        /// <summary>
        /// Creates a new instance of the EasyColorTable class.
        /// </summary>
        /// <param name="palette">Reference to associated palette.</param>
        public EasyColorTable(IPalette palette)
        {
            _palette = palette;
        }
        #endregion
