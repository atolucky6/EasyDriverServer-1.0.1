...
namespace EasyScada.Winforms.Controls
{
    ...
    public class PaletteContentInheritNode : PaletteContentInherit
	{
        ...
        {
            EasyTreeNode easyNode = TreeNode as EasyTreeNode;

            if ((easyNode != null) && (easyNode.LongNodeFont != null))
                return easyNode.LongNodeFont;
            else
        ...
        public override Color GetContentLongTextColor1(PaletteState state)
        {
            ...
            if ((easyNode != null) && (easyNode.LongForeColor != Color.Empty))
                return easyNode.LongForeColor;
            else
