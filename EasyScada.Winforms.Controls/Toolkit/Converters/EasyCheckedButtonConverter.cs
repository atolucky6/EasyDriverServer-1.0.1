...
{
    internal class EasyCheckedButtonConverter : ReferenceConverter
    {
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyCheckedButtonConverter class.
        /// </summary>
        public EasyCheckedButtonConverter()
            : base(typeof(EasyCheckButton))
        {
        }
        #endregion
        ...
        protected override bool IsValueAllowed(ITypeDescriptorContext context, object value)
        {
            ...
            EasyCheckSet checkSet = context.Instance as EasyCheckSet;
            ...
            if (checkSet != null)
            {
                ...
                return checkSet.CheckButtons.Contains(value as EasyCheckButton);
            }
            else
                return false;
        }
