...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyContextMenuMonthCalendar), "ToolboxBitmaps.EasyMonthCalendar.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultEvent("DateChanged")]
    [DefaultProperty("SelectionRange")]
    public class EasyContextMenuMonthCalendar : EasyContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuMonthCalendar class.
        /// </summary>
        public EasyContextMenuMonthCalendar()
        {
            // Default fields
            _autoClose = true;
            _enabled = true;
