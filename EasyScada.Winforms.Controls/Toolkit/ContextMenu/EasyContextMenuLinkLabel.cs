...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyContextMenuLinkLabel), "ToolboxBitmaps.EasyLinkLabel.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Text")]
    [DefaultEvent("Click")]
    public class EasyContextMenuLinkLabel : EasyContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuLinkLabel class.
        /// </summary>
        public EasyContextMenuLinkLabel()
            : this("LinkLabel")
        {
        }
        ...
        public EasyContextMenuLinkLabel(string initialText)
        {
            // Default fields
            _text = initialText;
            ...
            _inheritBehavior = new LinkLabelBehaviorInherit(_stateNormal, EasyLinkBehavior.AlwaysUnderline);
        ...
        [DefaultValue(typeof(EasyLinkBehavior), "Always Underline")]
        public EasyLinkBehavior LinkBehavior
        {
