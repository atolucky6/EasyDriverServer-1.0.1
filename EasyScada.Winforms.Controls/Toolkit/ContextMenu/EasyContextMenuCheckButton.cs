...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyContextMenuCheckButton), "ToolboxBitmaps.EasyCheckButton.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Text")]
    [DefaultEvent("CheckedChanged")]
    public class EasyContextMenuCheckButton : EasyContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuCheckButton class.
        /// </summary>
        public EasyContextMenuCheckButton()
            : this("CheckButton")
        {
        }
        ...
        public EasyContextMenuCheckButton(string initialText)
        {
            // Default fields
            _enabled = true;
            _autoClose = false;
