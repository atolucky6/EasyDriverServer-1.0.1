...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyContextMenuSeparator), "ToolboxBitmaps.EasyContextMenuSeparator.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Horizontal")]
    public class EasyContextMenuSeparator : EasyContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuSeparator class.
        /// </summary>
        public EasyContextMenuSeparator()
        {
            // Default fields
            _horizontal = true;
        ...
        public override ViewBase GenerateView(IContextMenuProvider provider,
                                              ...
                                              bool imageColumn)
        {
            if (Horizontal && (parent is EasyContextMenuItemCollection))
            {
