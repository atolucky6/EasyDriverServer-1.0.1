...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyContextMenuImageSelect), "ToolboxBitmaps.EasyContextMenuImageSelect.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("ImageList")]
    [DefaultEvent("SelectedIndexChanged")]
    public class EasyContextMenuImageSelect : EasyContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuImageSelect class.
        /// </summary>
        public EasyContextMenuImageSelect()
        {
            _autoClose = true;
            _selectedIndex = -1;
            _trackingIndex = -1;
