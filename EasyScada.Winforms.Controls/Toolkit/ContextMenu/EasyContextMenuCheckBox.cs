...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyContextMenuCheckBox), "ToolboxBitmaps.EasyCheckBox.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Text")]
    [DefaultEvent("CheckedChanged")]
    public class EasyContextMenuCheckBox : EasyContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuCheckBox class.
        /// </summary>
        public EasyContextMenuCheckBox()
            : this("CheckBox")
        {
        }
        ...
        public EasyContextMenuCheckBox(string initialText)
        {
            // Default fields
            _enabled = true;
            _autoClose = false;
