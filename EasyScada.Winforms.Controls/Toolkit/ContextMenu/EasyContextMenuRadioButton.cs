...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    [ToolboxBitmap(typeof(EasyContextMenuRadioButton), "ToolboxBitmaps.EasyRadioButton.bmp")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Text")]
    [DefaultEvent("CheckedChanged")]
    public class EasyContextMenuRadioButton : EasyContextMenuItemBase
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuRadioButton class.
        /// </summary>
        public EasyContextMenuRadioButton()
            : this("RadioButton")
        {
        }
        ...
        public EasyContextMenuRadioButton(string initialText)
        {
            // Default fields
            _enabled = true;
            _autoClose = false;
