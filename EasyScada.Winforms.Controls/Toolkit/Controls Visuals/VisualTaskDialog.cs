...
namespace EasyScada.Winforms.Controls
{
    ...
    [ComVisible(true)]
    public class VisualTaskDialog : EasyForm
    {
        #region Types
        /// <summary>
        ...
        #region Instance Fields
        private EasyTaskDialog _taskDialog;
        private string _windowTitle;
        private string _mainInstruction;
        private string _content;
        private MessageBoxIcon _mainIcon;
        private Image _customMainIcon;
        private EasyTaskDialogCommandCollection _radioButtons;
        private EasyTaskDialogCommandCollection _commandButtons;
        private EasyTaskDialogCommand _defaultRadioButton;
        ...
        // User Interface
        private EasyPanel _panelMain;
        private EasyPanel _panelIcon;
        ...
        private EasyBorderEdge _panelButtonsBorderTop;
        private EasyPanel _panelFooter;
        private EasyLinkLabel _linkLabelFooter;
        private PictureBox _iconFooter;
        private EasyWrapLabel _footerLabel;
        private EasyBorderEdge _panelFooterBorderTop;
        private EasyCheckBox _checkBox;
        private EasyPanel _panelMainRadio;
        private EasyPanel _panelMainCommands;
        private EasyPanel _panelMainSpacer;
        ...
        public VisualTaskDialog(EasyTaskDialog taskDialog)
        {
        ...
        private void UpdateRadioButtons()
        {
            ...
            else
            {
                ...
                foreach (EasyTaskDialogCommand command in _radioButtons)
                {
                    // Create and add a new radio button instance
                    EasyRadioButton button = new EasyRadioButton();
                ...
                foreach (EasyRadioButton button in _panelMainRadio.Controls)
                {
        ...
        private void UpdateButtons()
        {
            ...
            if ((_commonButtons & TaskDialogButtons.OK) == TaskDialogButtons.OK)
            {
                ...
                _buttonOK.Text = EasyManager.Strings.OK;
            ...
            if ((_commonButtons & TaskDialogButtons.Yes) == TaskDialogButtons.Yes)
            {
                ...
                _buttonYes.Text = EasyManager.Strings.Yes;
            ...
            if ((_commonButtons & TaskDialogButtons.No) == TaskDialogButtons.No)
            {
                ...
                _buttonNo.Text = EasyManager.Strings.No;
            ...
            if ((_commonButtons & TaskDialogButtons.Cancel) == TaskDialogButtons.Cancel)
            {
                ...
                _buttonCancel.Text = EasyManager.Strings.Cancel;
            ...
            if ((_commonButtons & TaskDialogButtons.Retry) == TaskDialogButtons.Retry)
            {
                ...
                _buttonRetry.Text = EasyManager.Strings.Retry;
            ...
            if ((_commonButtons & TaskDialogButtons.Close) == TaskDialogButtons.Close)
            {
                ...
                _buttonClose.Text = EasyManager.Strings.Close;
        ...
        {
            EasyRadioButton button = (EasyRadioButton)sender;
            _defaultRadioButton = (EasyTaskDialogCommand)button.Tag;
        ...
        private void OnCommandClicked(object sender, EventArgs e)
        {
            ...
            EasyTaskDialogCommand command = (EasyTaskDialogCommand)button.Tag;
        ...
        {
            this._panelMain = new EasyScada.Winforms.Controls.EasyPanel();
            this._panelMainSpacer = new EasyScada.Winforms.Controls.EasyPanel();
            this._panelMainCommands = new EasyScada.Winforms.Controls.EasyPanel();
            ...
            this._panelButtons = new EasyScada.Winforms.Controls.EasyPanel();
            this._checkBox = new EasyScada.Winforms.Controls.EasyCheckBox();
            this._panelButtonsBorderTop = new EasyScada.Winforms.Controls.EasyBorderEdge();
            this._buttonOK = new EasyScada.Winforms.Controls.VisualTaskDialog.MessageButton();
            this._buttonYes = new EasyScada.Winforms.Controls.VisualTaskDialog.MessageButton();
            this._buttonNo = new EasyScada.Winforms.Controls.VisualTaskDialog.MessageButton();
            this._buttonRetry = new EasyScada.Winforms.Controls.VisualTaskDialog.MessageButton();
            this._buttonCancel = new EasyScada.Winforms.Controls.VisualTaskDialog.MessageButton();
            this._buttonClose = new EasyScada.Winforms.Controls.VisualTaskDialog.MessageButton();
            this._panelFooter = new EasyScada.Winforms.Controls.EasyPanel();
            this._linkLabelFooter = new EasyScada.Winforms.Controls.EasyLinkLabel();
            this._iconFooter = new System.Windows.Forms.PictureBox();
            this._footerLabel = new EasyScada.Winforms.Controls.EasyWrapLabel();
            this._panelFooterBorderTop = new EasyScada.Winforms.Controls.EasyBorderEdge();
            ...
            this._messageContent.LabelStyle = EasyScada.Winforms.Controls.LabelStyle.NormalPanel;
            ...
            this._messageText.LabelStyle = EasyScada.Winforms.Controls.LabelStyle.TitlePanel;
            ...
            this._panelButtons.PanelBackStyle = EasyScada.Winforms.Controls.PaletteBackStyle.PanelAlternate;
            this._panelButtons.Size = new System.Drawing.Size(544, 46);
            this._panelButtons.TabIndex = 1;
            // 
            // _checkBox
            // 
            this._checkBox.LabelStyle = EasyScada.Winforms.Controls.LabelStyle.NormalPanel;
            ...
            // 
            this._panelButtonsBorderTop.BorderStyle = EasyScada.Winforms.Controls.PaletteBorderStyle.HeaderPrimary;
            ...
            this._panelButtonsBorderTop.Text = "easyBorderEdge1";
            // 
            // _buttonOK
            // 
            ...
            this._panelFooter.PanelBackStyle = EasyScada.Winforms.Controls.PaletteBackStyle.PanelAlternate;
            this._panelFooter.Size = new System.Drawing.Size(544, 49);
            this._panelFooter.TabIndex = 2;
            // 
            // _linkLabelFooter
            // 
            this._linkLabelFooter.LabelStyle = EasyScada.Winforms.Controls.LabelStyle.NormalPanel;
            ...
            this._linkLabelFooter.Values.Text = "easyLinkLabel1";
            ...
            this._footerLabel.LabelStyle = EasyScada.Winforms.Controls.LabelStyle.NormalPanel;
            ...
            // 
            this._panelFooterBorderTop.BorderStyle = EasyScada.Winforms.Controls.PaletteBorderStyle.HeaderPrimary;
            ...
            this._panelFooterBorderTop.Text = "easyBorderEdge1";
            // 
            // VisualTaskDialog
            // 
