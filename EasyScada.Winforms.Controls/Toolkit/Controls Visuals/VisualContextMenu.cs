...
{
    /// <summary>
    /// Base class for drawing a easy context menu as a popup control.
    /// </summary>
    public class VisualContextMenu : VisualPopup
    {
            ...
            : base(true)
        {
            ...
            if (provider.ProviderPalette != null)
                ...
                SetPalette(EasyManager.GetPaletteForMode(provider.ProviderPaletteMode));
        ...
        /// <param name="keyboardActivated">Was the context menu activate by a keyboard action.</param>
        public VisualContextMenu(EasyContextMenu contextMenu,
                                 IPalette palette,
            ...
            : base(true)
        {
            ...
            if (palette != null)
                ...
                SetPalette(EasyManager.GetPaletteForMode(paletteMode));
        ...
        public new void Show(Rectangle screenRect)
        {
            ...
            Show(screenRect, EasyContextMenuPositionH.Left, EasyContextMenuPositionV.Below);
        }
        ...
        public void Show(Rectangle screenRect,
                         EasyContextMenuPositionH horz,
                         EasyContextMenuPositionV vert)
        {
                         ...
                         bool constrain)
        {
            ...
            switch (horz)
            {
                ...
                case EasyContextMenuPositionH.Before:
                    ...
                    break;
                case EasyContextMenuPositionH.Left:
                    screenPt.X = screenRect.Left;
                    break;
                case EasyContextMenuPositionH.Right:
            ...
            switch (vert)
            {
                ...
                case EasyContextMenuPositionV.Below:
                    ...
                    break;
                case EasyContextMenuPositionV.Top:
                    screenPt.Y = screenRect.Top;
                    break;
                case EasyContextMenuPositionV.Bottom:
            ...
            if (bounce)
            {
                ...
                if ((screenPt.X + preferredSize.Width) > workingArea.Right)
                {
                    ...
                    if ((horz == EasyContextMenuPositionH.After) ||
                        (horz == EasyContextMenuPositionH.Left))
                    {
                        // Then switch to positioning before
                        horz = EasyContextMenuPositionH.Before;
                        screenPt.X = screenRect.Left - preferredSize.Width; 
                    }
                }
                ...
                if (screenPt.X < workingArea.X)
                {
                    ...
                    if ((horz == EasyContextMenuPositionH.Before) ||
                        (horz == EasyContextMenuPositionH.Right))
                    {
                        // Then switch to positioning after
                        horz = EasyContextMenuPositionH.After;
                        screenPt.X = screenRect.Right;
                    }
                }
                ...
                if ((screenPt.Y + preferredSize.Height) > workingArea.Bottom)
                {
                    ...
                    if ((vert == EasyContextMenuPositionV.Below) ||
                        (vert == EasyContextMenuPositionV.Top))
                    {
                        // Then switch to positoning upwards
                        vert = EasyContextMenuPositionV.Bottom;
                        screenPt.Y = screenRect.Bottom - preferredSize.Height;
                    }
                }
                ...
                if (screenPt.Y < workingArea.Y)
                {
                    ...
                    if ((vert == EasyContextMenuPositionV.Above) ||
                        (vert == EasyContextMenuPositionV.Bottom))
                    {
        ...
        /// </summary>
        public EasyContextMenuPositionH ShowHorz
        {
        ...
        /// </summary>
        public EasyContextMenuPositionV ShowVert
        {
        ...
        private void Construct(EasyContextMenuCollection items,
                               bool keyboardActivated)
        {
