...
{
    /// <summary>
    /// Specialized version of the visual context menu that knows about the EasyDateTimePicker drop down button.
    /// </summary>
    public class VisualContextMenuDTP : VisualContextMenu
    {
        ...
        public VisualContextMenuDTP(EasyContextMenu contextMenu,
                                    IPalette palette,
        ...
        public override bool DoesMouseDownGetEaten(Message m, Point pt)
        {
            ...
            // the EasyDateTimePicker then eat the down message to prevent the down press from
