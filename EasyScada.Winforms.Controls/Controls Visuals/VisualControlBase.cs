...
namespace EasyScada.Winforms.Controls
{
                                              ...
                                              IEasyDebug
    {
        ...
        private bool _allowTransparentBackground;
        ...
        protected VisualControlBase()
        {
            ...
            _localPalette = null;
            SetPalette(EasyManager.CurrentGlobalPalette);
        ...
        {
            get { return _easyContextMenu; }

            set
            {
                if (_easyContextMenu != value)
                {
                    if (_easyContextMenu != null)
                    {
                        _easyContextMenu.Closed -= new ToolStripDropDownClosedEventHandler(OnContextMenuClosed);
                        _easyContextMenu.Disposed -= new EventHandler(OnEasyContextMenuDisposed);
                    }

                    _easyContextMenu = value;
                ...
                if (_paletteMode != value)
                {
                    ...
                    switch (value)
                    {
                        ...
                        default:
                            ...
                            _localPalette = null;
                            SetPalette(EasyManager.GetPaletteForMode(_paletteMode));
        ...
        /// <summary>
        /// Gets and sets indicating the control should draw transparent background or not 
        /// </summary>
        [Category("Visuals")]
        [Description("Determine the background should draw transparent background or not")]
        [DefaultValue(true)]
        public bool AllowTransparentBackground
        {
            get { return _allowTransparentBackground; }
            set
            {
                if (_allowTransparentBackground != value)
                {
                    _allowTransparentBackground = value;
        ...
        #region Public IEasyDebug
        /// <summary>
        /// Reset the internal counters.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public void EasyResetCounters()
        {
        ...
        /// <summary>
        /// Force the control to perform a easy layout to calculate size and positioning.
        /// </summary>
        ...
        protected virtual void UpdateGlobalEvents(bool attach)
        {
            if (attach)
            {
                EasyManager.GlobalPaletteChanged += new EventHandler(OnGlobalPaletteChanged);
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (EasyContextMenu != null)
                if (EasyContextMenu.ProcessShortcut(keyData))
                    return true;
        ...
        private void PaintTransparentBackground(PaintEventArgs e)
        {
            ...
            else
            {
                ...
                PaintBackground(e.Graphics, new SolidBrush(BackColor), ClientRectangle);
            }
        }
