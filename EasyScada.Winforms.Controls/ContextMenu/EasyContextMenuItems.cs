...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    //[ToolboxBitmap(typeof(EasyContextMenuItems), "ToolboxBitmaps.EasyContextMenuItems.bmp")]
    //[Designer("ComponentFactory.Easy.Toolkit.EasyContextMenuItemsDesigner, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Items")]
    public class EasyContextMenuItems : EasyContextMenuItemBase
    {
        #region Instance Fields
        private bool _standardStyle;
        private bool _imageColumn;
        private EasyContextMenuItemCollection _items;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuItems class.
        /// </summary>
        public EasyContextMenuItems()
            : this(null)
        {
        }
        ...
        public EasyContextMenuItems(EasyContextMenuItemBase[] children)
        {
            // Default fields
            _standardStyle = true;
            _imageColumn = true;
            _items = new EasyContextMenuItemCollection();

            // Add any initial set of item
            if (children != null)
                _items.AddRange(children);

            // Create the redirector that can get values from the easy context menu
        ...
        [Editor("ComponentFactory.Easy.Toolkit.EasyContextMenuItemCollectionEditor, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e", typeof(UITypeEditor))]
        public EasyContextMenuItemCollection Items
        {
            get { return _items; }
        }
