...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    //[ToolboxBitmap(typeof(EasyContextMenuItem), "ToolboxBitmaps.EasyContextMenuItem.bmp")]
    //[Designer("ComponentFactory.Easy.Toolkit.EasyContextMenuItemDesigner, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    [DesignerCategory("code")]
    [DesignTimeVisible(false)]
    [DefaultProperty("Text")]
    [DefaultEvent("Click")]
    public class EasyContextMenuItem : EasyContextMenuItemBase
    {
        ...
        private bool _largeEasyCommandImage;
        ...
        private EasyContextMenuCollection _items;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyContextMenuItem class.
        /// </summary>
        public EasyContextMenuItem()
        ...
        public EasyContextMenuItem(string initialText)
        ...
        [Browsable(false)]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public override EasyContextMenuItemBase this[int index]
        {
            get { return null; }
        }
        ...
        /// <summary>
        /// Gets and sets if the large image is used from the attached EasyCommand.
        /// </summary>
        [EasyPersist]
        [Category("Behavior")]
        [Description("Determines if the large image is used from the attached EasyCommand.")]
        [DefaultValue(false)]
        public bool LargeEasyCommandImage
        {
            get { return _largeEasyCommandImage; }

            set
            {
                if (_largeEasyCommandImage != value)
                {
                    _largeEasyCommandImage = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("LargeEasyCommandImage"));
                }
            }
        }
        ...
        [Editor("ComponentFactory.Easy.Toolkit.EasyContextMenuCollectionEditor, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e", typeof(UITypeEditor))]
        public EasyContextMenuCollection Items
        {
            get { return _items; }
        }
        ...
        public virtual EasyCommand EasyCommand
        {
            ...
            set
            {
                ...
                {
                    _command = value;
                    OnPropertyChanged(new PropertyChangedEventArgs("EasyCommand"));
                }
            }
        }
        ...
        public void PerformClick()
        {
            ...
            if (CheckOnClick)
            {
                ...
                CheckState state = (EasyCommand == null ? CheckState : EasyCommand.CheckState);
