...
namespace EasyScada.Winforms.Controls
{
    ...
    public class EasyContextMenuCollection : TypedRestrictCollection<EasyContextMenuItemBase>
    {
        #region Static Fields
        private static readonly Type[] _types = new Type[] { typeof(EasyContextMenuItems),
        ...
        public bool ProcessShortcut(Keys keyData)
        {
            ...
            foreach (EasyContextMenuItemBase item in this)
            ...
            foreach (EasyContextMenuItemBase item in this)
            {
                if (item.Visible)
                {
                    ...
                    if (item is EasyContextMenuSeparator)
                    {
                        ...
                        EasyContextMenuSeparator separator = (EasyContextMenuSeparator)item;
        ...
        protected override void OnInserted(TypedCollectionEventArgs<EasyContextMenuItemBase> e)
        {
            base.OnInserted(e);

            // We monitor changes to the checked state of radio buttons
            EasyContextMenuRadioButton radioButton = e.Item as EasyContextMenuRadioButton;
            if (radioButton != null)
        ...
        /// </summary>
        /// <param name="e">A TypedCollectionEventArgs instance containing event data.</param>
        protected override void OnRemoving(TypedCollectionEventArgs<EasyContextMenuItemBase> e)
        {
        ...
        {
            EasyContextMenuRadioButton radioButton = sender as EasyContextMenuRadioButton;
        ...
        private void UncheckRadioButtons(int start, int end, int change)
        {
            ...
            if ((start >= 0) && (start < Count))
            {
                do
                {
                    EasyContextMenuRadioButton radioButton = this[start] as EasyContextMenuRadioButton;
    ...
    /// </summary>
    public class EasyContextMenuItemCollection : TypedRestrictCollection<EasyContextMenuItemBase>
    {
        #region Static Fields
        private static readonly Type[] _types = new Type[] { typeof(EasyContextMenuItem),
                                                             typeof(EasyContextMenuSeparator),
                                                             typeof(EasyContextMenuHeading) };
        #endregion
