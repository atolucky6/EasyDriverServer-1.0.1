...
{
    /// <summary>
    /// Combines button functionality with the styling features of the Easy Toolkit.
    /// </summary>
    [ToolboxItem(true)]
    //[ToolboxBitmap(typeof(EasyButton), "ToolboxBitmaps.EasyButton.bmp")]
    [DefaultEvent("Click")]
    ...
    [ComVisible(true)]
    public class EasyButton : VisualSimpleBase, IButtonControl, IContentValues, ISupportConnector, ISupportPalette, ISupportWriteMultiTag
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyButton class.
		/// </summary>
        public EasyButton()
        {
            ...
            // Create write tag commands collection
        ...
        public WriteTagCommandCollection WriteTagCommands
        {
            get { return _writeTagCommands; }
        }
        ...
        [DefaultValue(null)]
        public virtual IEasyCommand EasyCommand
        {
            get { return _command; }
