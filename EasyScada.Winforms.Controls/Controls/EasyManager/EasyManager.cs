...
{
    /// <summary>
    /// Exposes global settings that affect all the Easy controls.
    /// </summary>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(EasyManager), "ToolboxBitmaps.EasyManager.bmp")]
    [Designer("ComponentFactory.Easy.Toolkit.EasyManagerDesigner, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    [DefaultProperty("GlobalPaletteMode")]
    [Description("Access global Easy settings.")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public sealed class EasyManager : Component
    {
        ...
        /// <summary>
        /// Initialize a new instance of the EasyManager class.
        /// </summary>
        public EasyManager()
        {
        }
        ...
        public EasyManager(IContainer container)
            : this()
        {
        ...
        {
            get { return EasyManager.ApplyToolstrips; }
            set { EasyManager.ApplyToolstrips = value; }
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating if EasyForm instances are allowed to show custom chrome.
        /// </summary>
        [Category("Visuals")]
        [Description("Should EasyForm instances be allowed to show custom chrome.")]
        [DefaultValue(true)]
        public bool GlobalAllowFormChrome
        {
            get { return EasyManager.AllowFormChrome; }
            set { EasyManager.AllowFormChrome = value; }
        }
        ...
        /// <summary>
        /// Gets a set of global strings used by Easy that can be localized.
        /// </summary>
        [Category("Visuals")]
        ...
        internal static bool HasCircularReference()
        {
            ...
            if (EasyManager.InternalGlobalPaletteMode == PaletteModeManager.Custom)
