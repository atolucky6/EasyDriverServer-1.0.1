...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(EasyMonthCalendar), "ToolboxBitmaps.EasyMonthCalendar.bmp")]
    [DefaultEvent("DateChanged")]
    [DefaultProperty("SelectionRange")]
    [DefaultBindingProperty("SelectionRange")]
    [Designer("ComponentFactory.Easy.Toolkit.EasyMonthCalendarDesigner, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    [DesignerCategory("code")]
    [Description("Select a date using a visual monthly calendar display.")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyMonthCalendar : VisualSimpleBase,
                                     IEasyMonthCalendar
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyMonthCalendar class.
		/// </summary>
        public EasyMonthCalendar()
        {
