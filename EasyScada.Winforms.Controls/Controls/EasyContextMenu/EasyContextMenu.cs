...
{
    /// <summary>
    /// Represents a shortcut menu with Easy palette styling.
    /// </summary>
    [ToolboxItem(true)]
    //[ToolboxBitmap(typeof(EasyContextMenu), "ToolboxBitmaps.EasyContextMenu.bmp")]
    [DefaultEvent("Opening")]
    [DefaultProperty("PaletteMode")]
    [DesignerCategory("code")]
    //[Designer("ComponentFactory.Easy.Toolkit.EasyContextMenuDesigner, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    [Description("Displays a shortcut menu in popup window.")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyContextMenu : Component
    {
        ...
        #region Identity
        /// <summary>
        ///  Initialize a new instance of the EasyContextMenu class.
        /// </summary>
        public EasyContextMenu()
        {
                         ...
                         Rectangle screenRect)
        {
            ...
            return Show(caller, screenRect, EasyContextMenuPositionH.Left, EasyContextMenuPositionV.Below);
        }
                         ...
                         bool constrain)
        {
            ...
            if (_contextMenu == null)
            {
                ...
                if (!cea.Cancel)
                {
                    ...
                    _contextMenu.ShowHorz = EasyContextMenuPositionH.After;
                    _contextMenu.ShowVert = EasyContextMenuPositionV.Top;
        ...
        protected virtual VisualContextMenu CreateContextMenu(EasyContextMenu kcm,
                                                              IPalette palette,
