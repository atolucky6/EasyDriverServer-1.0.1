...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(EasyCommand), "ToolboxBitmaps.EasyCommand.bmp")]
    [DefaultEvent("Click")]
    [DefaultProperty("Text")]
    [DesignerCategory("code")]
    [Designer("ComponentFactory.Easy.Toolkit.EasyCommandDesigner, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    [Description("Defines state and events for a single command.")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyCommand : Component, IEasyCommand, INotifyPropertyChanged
    {
    ...
    /// <summary>
    /// Manages a collection of EasyCommand instances.
    /// </summary>
    public class EasyCommandCollection : TypedCollection<EasyCommand>
    {
        #region Public
        /// <summary>
        ...
        public override EasyCommand this[string name]
        {
            get
            {
                if (!string.IsNullOrEmpty(name))
                {
                    foreach (EasyCommand item in this)
                    {
