...
{
    /// <summary>
    /// Define and modify a palette for styling Easy controls.
    /// </summary>
    [ToolboxItem(true)]
    [ToolboxBitmap(typeof(EasyPalette), "ToolboxBitmaps.EasyPalette.bmp")]
    [DefaultEvent("PalettePaint")]
    [DefaultProperty("BasePaletteMode")]
    [DesignerCategory("code")]
    [Designer("ComponentFactory.Easy.Toolkit.EasyPaletteDesigner, ComponentFactory.Easy.Toolkit, Version=4.6.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    [Description("Customisable palette component.")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ComVisible(true)]
    public class EasyPalette : Component, IPalette
    {
        ...
        private EasyPaletteCheckButtons _buttons;
        private EasyPaletteButtonSpecs _buttonSpecs;
        private EasyPaletteCalendarDay _calendarDay;
        private EasyPaletteCargo _cargo;
        private EasyPaletteCommon _common;
        private EasyPaletteContextMenu _contextMenu;
        private EasyPaletteControls _controls;
        private PaletteDragDrop _dragDrop;
        private EasyPaletteForms _forms;
        private EasyPaletteGrids _grids;
        private EasyPaletteHeaders _headers;
        private EasyPaletteHeaderGroup _headerGroup;
        private EasyPaletteImages _images;
        private EasyPaletteInputControls _inputControls;
        private EasyPaletteLabels _labels;
        private EasyPaletteNavigator _navigator;
        private EasyPalettePanels _panels;
        private EasyPaletteRibbon _ribbon;
        private EasyPaletteSeparators _separators;
        private EasyPaletteTabButtons _tabs;
        private EasyPaletteTrackBar _trackBar;
        private EasyPaletteTMS _toolMenuStatus;
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyPalette class.
        /// </summary>
        public EasyPalette()
        {
            ...
            _basePalette = EasyManager.GetPaletteForMode(PaletteMode.Office2010Blue);
            ...
            _common = new EasyPaletteCommon(_redirector, _needPaintDelegate);
            ...
            _buttons = new EasyPaletteCheckButtons(_redirectCommon, _needPaintDelegate);
            _buttonSpecs = new EasyPaletteButtonSpecs(_redirector);
            _calendarDay = new EasyPaletteCalendarDay(_redirector, _needPaintDelegate);
            _cargo = new EasyPaletteCargo(_needPaintDelegate);
            _controls = new EasyPaletteControls(_redirectCommon, _needPaintDelegate);
            _contextMenu = new EasyPaletteContextMenu(_redirectCommon, _needPaintDelegate);
            _dragDrop = new PaletteDragDrop(_redirectCommon, _needPaintDelegate);
            _forms = new EasyPaletteForms(_redirectCommon, _needPaintDelegate);
            _grids = new EasyPaletteGrids(_redirectCommon, _needPaintDelegate);
            _headers = new EasyPaletteHeaders(_redirectCommon, _needPaintDelegate);
            _headerGroup = new EasyPaletteHeaderGroup(_redirector, _needPaintDelegate);
            _images = new EasyPaletteImages(_redirectCommon, _needPaintDelegate);
            _inputControls = new EasyPaletteInputControls(_redirectCommon, _needPaintDelegate);
            _labels = new EasyPaletteLabels(_redirectCommon, _needPaintDelegate);
            _navigator = new EasyPaletteNavigator(_redirectCommon, _needPaintDelegate);
            _panels = new EasyPalettePanels(_redirectCommon, _needPaintDelegate);
            _ribbon = new EasyPaletteRibbon(_redirectCommon, _needPaintDelegate);
            _separators = new EasyPaletteSeparators(_redirectCommon, _needPaintDelegate);
            _tabs = new EasyPaletteTabButtons(_redirectCommon, _needPaintDelegate);
            _trackBar = new EasyPaletteTrackBar(_redirectCommon, _needPaintDelegate);
            _toolMenuStatus = new EasyPaletteTMS(this, _basePalette.ColorTable, _needTMSPaintDelegate);
        ...
        public EasyPalette(IContainer container)
            : this()
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating if EasyForm instances should show custom chrome.
        /// </summary>
        [EasyPersist(false)]
        [Category("Visuals")]
        [Description("Should EasyForm instances show custom chrome.")]
        ...
        public EasyPaletteButtonSpecs ButtonSpecs
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteCheckButtons ButtonStyles
        {
            get { return _buttons; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteCalendarDay CalendarDay
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteCommon Common
        {
            get { return _common; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteControls ControlStyles
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteContextMenu ContextMenu
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteForms FormStyles
        {
            get { return _forms; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteHeaderGroup HeaderGroup
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteHeaders HeaderStyles
        {
            get { return _headers; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteGrids GridStyles
        {
            get { return _grids; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteImages Images
        {
            get { return _images; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteInputControls InputControlStyles
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteLabels LabelStyles
        {
            get { return _labels; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteNavigator Navigator
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPalettePanels PanelStyles
        {
            get { return _panels; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteRibbon Ribbon
        {
            get { return _ribbon; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteSeparators SeparatorStyles
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteTabButtons TabStyles
        {
            get { return _tabs; }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteTrackBar TrackBar
        {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public EasyPaletteTMS ToolMenuStatus
        {
        ...
        public IRenderer GetRenderer()
        {
            switch (_baseRenderMode)
            {
                ...
                default:
                    ...
                    return EasyManager.GetRendererForMode(_baseRenderMode);
            }
        }
        #endregion
        ...
        #region IPalette
        /// <summary>
        /// Gets a value indicating if EasyForm instances should show custom chrome.
        /// </summary>
        ...
        public Image GetGalleryButtonImage(PaletteRibbonGalleryButton button, PaletteState state)
        {
            ...
            EasyPaletteImagesGalleryButton images = null;
            switch (button)
            {
                ...
                if (_basePaletteMode != value)
                {
                    ...
                    switch (value)
                    {
                        ...
                        default:
                            ...
                            _basePalette = EasyManager.GetPaletteForMode(_basePaletteMode);
                            ...
                            SetPalette(EasyManager.GetPaletteForMode(_basePaletteMode));
        ...
        /// <summary>
        /// Gets and sets the EasyPalette used to inherit from.
        /// </summary>
        [Category("Visuals")]
        [Description("EasyPalette used to inherit from.")]
        [DefaultValue(null)]
                    ...
                    switch (value)
                    {
                        ...
                        default:
                            ...
                            if (value == RendererMode.Inherit)
                                ...
                                _baseRenderer = EasyManager.GetRendererForMode(_baseRenderMode);
        ...
        /// </summary>
        [Browsable(false)]
        public EasyColorTable ColorTable
        {
        ...
        internal bool HasCircularReference()
        {
            ...
            while (palette != null)
            {
                ...
                else
                {
                    ...
                    // If this is a EasyPalette instance
                    if (palette is EasyPalette)
                    {
                        // Cast to correct type
                        EasyPalette owner = (EasyPalette)palette;
                        ...
                        if (owner.BasePaletteMode == PaletteMode.Custom)
                            ...
                            palette = EasyManager.InternalGlobalPalette;
                        else
                            palette = null;
                    }
                    else
        ...
        private void ImportFromXmlDocument(XmlDocument doc)
        {
            ...
            try
            {
                ...
                XmlElement root = (XmlElement)doc.SelectSingleNode("EasyPalette");

                // We insist the root is always present
                if (root == null)
                    throw new ArgumentException("Root element must be called 'EasyPalette'.");
                ...
                if (version < _paletteVersion)
                    throw new ArgumentException("Version '" + version + "' number is incompatible, only version " + _paletteVersion.ToString() +
                                                " or above can be imported.\nUse the PaletteUpgradeTool from the Application tab of the EasyExplorer to upgrade.");
                ...
                if (props == null) throw new ArgumentException("Element 'Properties' missing from the 'EasyPalette'.");
                if (images == null) throw new ArgumentException("Element 'Images' missing from the 'EasyPalette'.");
        ...
        private XmlDocument ExportToXmlDocument(bool ignoreDefaults)
        {
            ...
            try
            {
                ...
                doc.AppendChild(doc.CreateComment("Created by exporting the settings of a EasyPalette instance."));
                doc.AppendChild(doc.CreateComment("For more information about Easy visit www.ComponentFactory.com"));
                ...
                XmlElement root = doc.CreateElement("EasyPalette");
            ...
            if (obj != null)
            {
                ...
                foreach (PropertyInfo prop in t.GetProperties())
                {
                    ...
                    foreach (object attrib in prop.GetCustomAttributes(false))
                    {
                        ...
                        if (attrib is EasyPersistAttribute)
                        {
                            // Cast attribute to the correct type
                            EasyPersistAttribute persist = (EasyPersistAttribute)attrib;
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonTab ribbonTab,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonAppButton ribbonAppButton,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonGroupArea ribbonGroupArea,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonGroupNormalBorder ribbonGroupNormalBorder,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonGroupNormalTitle ribbonGroupNormalTitle,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonGroupCollapsedBorder ribbonGroupCollapsedBorder,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonGroupCollapsedBack ribbonGroupCollapsedBack,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonGroupCollapsedFrameBorder ribbonGroupCollapsedFrameBorder,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonGroupCollapsedFrameBack ribbonGroupCollapsedFrameBack,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonBack GetPaletteRibbonBack(EasyPaletteRibbonQATMinibar ribbonQATMinibar,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonText GetPaletteRibbonText(EasyPaletteRibbonTab ribbonTab,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonText GetPaletteRibbonText(EasyPaletteRibbonGroupNormalTitle ribbonGroupNormalTitle,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonText GetPaletteRibbonText(EasyPaletteRibbonGroupCollapsedText ribbonGroupCollapsedText,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteRibbonText GetPaletteRibbonText(EasyPaletteRibbonGroupBaseText ribbonGroupButtonText,
                                                        PaletteState state)
        {
            switch (state)
            {
        ...
        private IPaletteBack GetPaletteBackButton(EasyPaletteCheckButton button, PaletteState state)
        {
        ...
        private PaletteBorder GetPaletteBorderButton(EasyPaletteCheckButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteContent GetPaletteContentButton(EasyPaletteCheckButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteTriple GetPaletteButton(EasyPaletteCheckButton button, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteBack GetPaletteBackCalendarDay(EasyPaletteCalendarDay button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteBorder GetPaletteBorderCalendarDay(EasyPaletteCalendarDay button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteContent GetPaletteContentCalendarDay(EasyPaletteCalendarDay button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteTriple GetPaletteCalendarDay(EasyPaletteCalendarDay button, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteTriple GetPaletteInputControl(EasyPaletteInputControl inputControl, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteBack GetPaletteBackTab(EasyPaletteTabButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteBorder GetPaletteBorderTab(EasyPaletteTabButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteContent GetPaletteContentTab(EasyPaletteTabButton button, PaletteState state)
        {
            // Have to special case states that do not derive from PaletteTriple
            switch (state)
            {
        ...
        private PaletteTabTriple GetPaletteTab(EasyPaletteTabButton button, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackSeparator(EasyPaletteSeparator separator, PaletteState state)
        {
        ...
        private PaletteBorder GetPaletteBorderSeparator(EasyPaletteSeparator separator, PaletteState state)
        {
            PaletteSeparatorPadding separatorState = GetPaletteSeparator(separator, state);
        ...
        private PaletteSeparatorPadding GetPaletteSeparator(EasyPaletteSeparator separator, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackControl(EasyPaletteControl control, PaletteState state)
        {
        ...
        private PaletteBorder GetPaletteBorderControl(EasyPaletteControl control, PaletteState state)
        {
            PaletteDouble controlState = GetPaletteControl(control, state);
        ...
        private PaletteDouble GetPaletteControl(EasyPaletteControl control, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackForm(EasyPaletteForm form, PaletteState state)
        {
        ...
        private PaletteBack GetPaletteBackGridBackground(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackGridHeaderColumn(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackGridHeaderRow(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackGridDataCell(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBorder GetPaletteBorderGridHeaderColumn(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBorder GetPaletteBorderGridHeaderRow(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBorder GetPaletteBorderGridDataCell(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteContent GetPaletteContentGridHeaderColumn(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteContent GetPaletteContentGridHeaderRow(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private IPaletteContent GetPaletteContentGridDataCell(EasyPaletteGrid grid, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBorder GetPaletteBorderForm(EasyPaletteForm form, PaletteState state)
        {
            PaletteDouble controlState = GetPaletteForm(form, state);
        ...
        private PaletteDouble GetPaletteForm(EasyPaletteForm form, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPaletteBackHeader(EasyPaletteHeader header, PaletteState state)
        {
        ...
        private PaletteBorder GetPaletteBorderHeader(EasyPaletteHeader header, PaletteState state)
        {
            PaletteTriple headerState = GetPaletteHeader(header, state);
        ...
        private PaletteContent GetPaletteContentHeader(EasyPaletteHeader header, PaletteState state)
        {
            PaletteTriple headerState = GetPaletteHeader(header, state);
        ...
        private PaletteTriple GetPaletteHeader(EasyPaletteHeader header, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteBack GetPalettePanel(EasyPalettePanel panel, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private PaletteContent GetPaletteLabel(EasyPaletteLabel label, PaletteState state)
        {
            switch (state)
            {
                case PaletteState.Disabled:
        ...
        private void OnNeedPaint(object sender, NeedLayoutEventArgs e)
        {
            ...
            if (_suspendCount == 0)
            {
                // Changing the easy control colors does not effect the menu/tool/status areas
