...
namespace EasyScada.Winforms.Controls
{
    internal class LinkLabelBehaviorInherit : PaletteContentInherit
    {
        ...
        private EasyLinkBehavior _linkBehavior;
        #endregion
        ...
        private Font GetContentFont(PaletteState state, Font font)
        {
            ...
            if (!CommonHelper.IsOverrideState(state))
            {
                ...
                {
                    case EasyLinkBehavior.AlwaysUnderline:
                        underline = true;
                        break;
                    case EasyLinkBehavior.HoverUnderline:
                        underline = ((state == PaletteState.Tracking) ||
                                     (state == PaletteState.Pressed));
                        break;
                    case EasyLinkBehavior.NeverUnderline:
                        // Nothing to do
                        break;
                }
