...
{
    internal class EasyProfessionalRenderer : ToolStripProfessionalRenderer
    {
        #region Instance Fields
        private EasyColorTable _kct;
        #endregion

        #region Identity
        /// <summary>
        /// Initialise a new instance of the EasyProfessionalRenderer class.
        /// </summary>
        /// <param name="kct">Source for text colors.</param>
        public EasyProfessionalRenderer(EasyColorTable kct)
            : base(kct)
        {
        ...
        #region KCT
        /// <summary>
        /// Gets access to the EasyColorTable instance.
        /// </summary>
        public EasyColorTable KCT
        {
            get { return _kct; }
        }
        #endregion
