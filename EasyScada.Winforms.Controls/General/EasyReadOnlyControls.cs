...
namespace EasyScada.Winforms.Controls
{
    ...
    /// </summary>
    public class EasyReadOnlyControls : EasyControlCollection
    {
        ...
        #region Identity
        /// <summary>
        /// Initialize a new instance of the EasyReadOnlyControls class.
        /// </summary>
        /// <param name="owner">Owning control.</param>
        public EasyReadOnlyControls(Control owner)
            : base(owner)
        {
            _allowRemove = false;
        }
