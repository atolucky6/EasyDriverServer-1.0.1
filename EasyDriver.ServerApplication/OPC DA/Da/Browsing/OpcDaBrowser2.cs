...
using EasyDriver.Opc.Client.Da.Browsing.Internal;
using EasyDriver.Opc.Client.Da.Wrappers;
using EasyDriver.Opc.Client.Interop.Da;
using EasyDriver.Opc.Client.Interop.Helpers;

namespace EasyDriver.Opc.Client.Da.Browsing
{
    /// <summary>
    ...
    public class OpcDaBrowser2 : IOpcDaBrowser
    {
        ...
        public OpcDaItemProperties[] GetProperties(IList<string> itemIds, OpcDaPropertiesQuery propertiesQuery = null)
        {
            ...
            if (propertiesQuery == null)
                propertiesQuery = new OpcDaPropertiesQuery(true);
