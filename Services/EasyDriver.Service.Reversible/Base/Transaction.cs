...
{
    public class Transaction : ReversibleChange, IDisposable
    {
        #region Static
        ...
        /// </summary>
        protected List<ReversibleChange> Changes = new List<ReversibleChange>();
        ...
        public virtual void AddChange(ReversibleChange change)
        {
            if (IsFinished)
