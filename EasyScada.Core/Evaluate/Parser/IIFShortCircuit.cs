...
namespace EasyScada.Core.Evaluate
{
    public class IIFShortCircuit
    {
        ...
        public IIFShortCircuit(TokenItem Parent)
        {
            ...
            rpn_condition = new ExQueue<TokenItem>();
            rpn_true = new ExQueue<TokenItem>();
            rpn_false = new ExQueue<TokenItem>();
        }
        ...
        public TokenItem Evaluate(out string ErrorMsg)
        {
            ...
            TokenExpression token = this.Parent.Parent.Parent;
            ...
            ExQueue<TokenItem> resultQueue = null;
